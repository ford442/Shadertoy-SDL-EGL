...
static GLuint shader_program,shader_programA;
...
uniform_time=glGetUniformLocation(shader_programA,"iChannelTime[0]");
uniform_time=glGetUniformLocation(shader_programA,"iChannelTime[1]");
uniform_time=glGetUniformLocation(shader_programA,"iChannelTime[2]");
uniform_time=glGetUniformLocation(shader_programA,"iChannelTime[3]");
