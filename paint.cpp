...
EGLint iFrame;
GLsizei s4=4;
int v0=0,v1=1,v2=2,v3=3,v4=4,v6=6,v8=8,v10=10,v24=24,v32=32,a,b;
GLfloat F=1.0f;
GLfloat F0=0.0f;
GLfloat Fm1=-1.0f;
GLfloat mouseX;
...
let glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g){return ((0.8+(3.0*((1.0-b)-(((((1.0-f)-(a)+b)*1.5)/2.0)+((f-0.5)*((1.0-f)*0.25))-((0.5-f)*(f*0.25))-((g-e)*((1.0-g)*0.1))))))/4.0);}`;
...
var grr=(p[0]-0.65)+(p[1]-0.65)+(p[2]-0.65)-(p[0]-0.78)-(p[1]-0.78)-(p[2]-0.78);
grr=Math.min(grr,0.0);
var rr=p[0]-grr;
var gg=p[1]-grr;
var bb=p[2]-grr;
