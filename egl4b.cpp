...
"#version 300 es\n precision lowp int;precision lowp float;\n";
...
"uniform lowp vec3 iResolution;uniform lowp float iTime;uniform lowp vec4 iMouse;uniform sampler2D iChannel0;uniform sampler2D iChannel1;uniform sampler2D iChannel2;uniform sampler2D iChannel3;out lowp vec4 fragColor;\n";
