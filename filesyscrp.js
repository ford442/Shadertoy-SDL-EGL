...
document.getElementById('btn').addEventListener('click',function(){
document.getElementById('btn3').style="background-color:red;position:absolute;display:none;left:3%;top:13%;z-index:999997;border:5px solid red;border-radius:50%;";
...
document.getElementById('btn7').style="background-color:red;position:absolute;display:none;left:3%;top:63%;z-index:999997;border:5px solid red;border-radius:50%;";
document.getElementById('btn').style="background-color:red;position:absolute;display:none;left:3%;top:23%;z-index:999997;border:5px solid red;border-radius:50%;"
});
...
document.getElementById("scanvas1").style="position:absolute;top:0;background-color:rgba(1,1,1,0);z-index:999994;image-rendering:auto;width:"+window.innerHeight+"px;height:"+window.innerHeight+"px;opacity:1.0;";
document.getElementById("scanvas2").style="position:absolute;top:0;background-color:rgba(1,1,1,0);z-index:999995;image-rendering:auto;width:"+window.innerHeight+"px;height:"+window.innerHeight+"px;opacity:0.666;";
document.getElementById("scanvas3").style="position:absolute;top:0;background-color:rgba(1,1,1,0);z-index:999996;image-rendering:auto;width:"+window.innerHeight+"px;height:"+window.innerHeight+"px;opacity:0.333;";
