...
glVertexAttribPointer(0,sides,GL_FLOAT,GL_FALSE,6*sizeof(float),(void*)0);
glEnableVertexAttribArray(0);
glVertexAttribPointer(1,sides,GL_FLOAT,GL_FALSE,6*sizeof(float),(void*)(3*sizeof(float)));
