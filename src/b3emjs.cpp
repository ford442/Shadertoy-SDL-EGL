...
}).setTactic("precision").setOptimizeFloatMemory(false).setPrecision("single").setFixIntegerDivisionAccuracy(false).setPipeline(true).setDynamicOutput(true).setOutput([w$,h$]);
