...
}).setTactic("precision").setPrecision("single").setOptimizeFloatMemory(true).setArgumentTypes(["HTMLVideo"]).setPipeline(true).setDynamicOutput(true).setOutput([w$,h$]);
...
}).setTactic("precision").setPrecision("single").setOptimizeFloatMemory(true).setGraphical(true).setDynamicOutput(true).setOutput([w$,h$]);
