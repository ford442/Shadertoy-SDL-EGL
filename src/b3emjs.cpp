...
}).setTactic("precision").setOptimizeFloatMemory(true).setPrecision("single").setFixIntegerDivisionAccuracy(false).setPipeline(true).setArgumentTypes(["4DArray"]).setDynamicOutput(true).setOutput([w$,h$]);
