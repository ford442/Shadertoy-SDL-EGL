...
}).setTactic("precision").setOptimizeFloatMemory(true).setPrecision("single").setFixIntegerDivisionAccuracy(false).setGraphical(true).setDynamicOutput(true).setOutput([w$,h$]);
