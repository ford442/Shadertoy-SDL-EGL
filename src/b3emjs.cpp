...
}).setTactic("precision").setOptimizeFloatMemory(true).setPrecision("single").setFixIntegerDivisionAccuracy(false).setPipeline(true).setDynamicOutput(true).setOutput([w$,h$]);
