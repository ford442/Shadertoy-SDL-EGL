...
var w$=parseInt(document.innerHeight,10);
var h$=parseInt(document.innerHeight,10);
...
}).setTactic("precision").setPipeline(true).setDynamicOutput(true).setArgumentTypes(["HTMLCanvas"]).setOutput([w$,h$]);
