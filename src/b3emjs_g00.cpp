...
ctx_js=emscripten_webgl_create_context("#mcanvas",&attr_js);
...
}).setTactic("precision").setPrecision("single").setPipeline(true).setArgumentTypes(["HTMLCanvas"]).setDynamicOutput(true).setOutput([w$,h$]);
