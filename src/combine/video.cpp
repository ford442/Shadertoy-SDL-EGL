...
emscripten_webgl_enable_extension(ctx_js,"GL_OES_float_blend");
...
emscripten_webgl_enable_extension(ctx_js,"GL_ARB_shading_language_420pack");
...
// emscripten_webgl_enable_extension(ctx_js,"GL_ARB_cull_distance");
...
gl.getExtension('GL_EXT_texture_filter_anisotropic');
