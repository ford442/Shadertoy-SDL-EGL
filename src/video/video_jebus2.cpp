...
}).setTactic("precision").setGraphical(true).setArgumentTypes(['HTMLVideo']).setDynamicOutput(true).setOutput([h$+(blank$*2),h$]).setStrictIntegers(false).setFixIntegerDivisionAccuracy(false);
