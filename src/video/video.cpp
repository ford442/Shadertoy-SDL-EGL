...
emscripten_webgl_enable_extension(ctx_js,"OES_shader_multisample_interpolation");
emscripten_webgl_enable_extension(ctx_js,"OES_draw_buffers_indexed");
emscripten_webgl_enable_extension(ctx_js,"ARB_draw_buffers_blend");
...
gl.getExtension('GL_EXT_color_buffer_float');
...
gl.getExtension('GL_ARB_invalidate_subdata');
gl.getExtension('GL_ARB_texture_storage');
gl.getExtension('GL_ARB_ES2_compatibility');
gl.getExtension('GL_ARB_ES3_compatibility');
gl.getExtension('GL_ARB_ES3_1_compatibility');
gl.getExtension('GL_ARB_ES3_2_compatibility');
...
gl.getExtension('GL_ARB_buffer_storage');
// gl.getExtension('GL_ARB_color_buffer_float');
gl.getExtension('GL_ARB_compatibility');
gl.getExtension('GL_ARB_compute_shader');
gl.getExtension('GL_ARB_enhanced_layouts');
gl.getExtension('GL_ARB_shadow');
gl.getExtension('GL_ARB_sync');
gl.getExtension('GL_ARB_tessellation_shader');
gl.getExtension('GL_ARB_texture_float');
...
gl.getExtension('GL_ARB_texture_stencil8');
gl.getExtension('OES_shader_multisample_interpolation');
gl.getExtension('OES_draw_buffers_indexed');
