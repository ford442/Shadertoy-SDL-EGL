...
}).setTactic("precision").setPipeline(true).setPrecision('single').setArgumentTypes(["HTMLVideo"]).setDynamicOutput(true).setOutput([h$,h$]);
...
}).setTactic("precision").setGraphical(true).setPrecision('single').setArgumentTypes(['HTMLVideo']).setDynamicOutput(true).setOutput([h$,h$]);
