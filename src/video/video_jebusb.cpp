...
eval("if ($F==="+i+"){var $$"+$Bu+"=t(vv);$"+$Bu+".set($$"+$Bu+");FS.writeFile('/video/frame"+$Bu+".gl',$"+$Bu+");$F="+loca+";$Bu="+locb+";var ff=new Float32Array(FS.readFile('/video/frame"+$Bu+".gl'));var $r"+i+"=t(ff);r($r"+i+");}");
}
var $bb=R(vv);
$B.set($bb,0,sz);
pointb=66*la;
