...
std::chrono::milliseconds time_spanb=duration_cast<std::chrono::milliseconds>(t2-t3);
Tdlt=time_spanb.count();
std::chrono::milliseconds time_spana=duration_cast<std::chrono::milliseconds>(t2-t1);
