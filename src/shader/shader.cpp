...
std::chrono::duration<long double, std::chrono::seconds::period>time_spana=std::chrono::duration<long double,std::chrono::seconds::period>(t2-t1);
...
glVertexAttribPointer(atb_pos,4,GL_HALF_FLOAT,GL_FALSE,0,(GLvoid*)0);
