...
t2=std::chrono::steady_clock::now();
 std::chrono::duration<float, std::chrono::seconds::period> time_spanb=duration_cast std::chrono::duration<float, std::chrono::seconds::period>(t2-t3);
Tdlt=time_spanb.count();
 std::chrono::duration<float, std::chrono::seconds::period>time_spana=duration_cast std::chrono::duration<float, std::chrono::seconds::period>(t2-t1);
