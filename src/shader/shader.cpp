...
std::chrono::seconds<float>time_spanb=duration_cast<std::chrono::seconds<float>>(t2-t3);
Tdlt=time_spanb.count();
std::chrono::seconds<long double>time_spana=duration_cast<std::chrono::seconds<long double>>(t2-t1);
