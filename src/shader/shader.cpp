...
emscripten_webgl_enable_extension(ctx,"GL_ARB_compatibility");
...
emscripten_webgl_enable_extension(ctx,"GL_EXT_framebuffer_multisample");
...
emscripten_webgl_enable_extension(ctx,"GL_OES_geometry_shader");
emscripten_webgl_enable_extension(ctx,"GL_ARB_texture_stencil8");
