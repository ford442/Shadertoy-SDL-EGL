...
wgpu_queue_write_buffer(wq.at(0,0),wb.at(8,8),0,&u64v.at(0,0)[0],sizeof(uint32_t)*3);
...
WGpuBufferDescriptor bufferDescriptorZoom={24,WGPU_BUFFER_USAGE_UNIFORM|WGPU_BUFFER_USAGE_COPY_DST,EM_FALSE};
