...
wgpu_queue_write_texture(WGPU_Queue.at(0,0,0),&wict.at(2,2),&frame_tensor.at(0,0),sze.at(1,1)*4,sze.at(1,1)-300,sze.at(1,1),sze.at(1,1),1);
         //  Render Pass
...
const char * comp_body=(char*)rd_fl(Fnm);
