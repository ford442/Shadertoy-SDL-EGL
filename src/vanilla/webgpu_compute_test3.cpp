...
"var clr:vec4<f32>=vec4<f32>(0.5f,0.0f,0.5f,1.0f);\n"
...
wicb.at(2,2)=const WGpuImageCopyBuffer inBuff;
...
// videoFrmBfrSrc.bytesPerRow=(floor((sze.at(1,1)*4)/256)+1)*256;
// videoFrmBfrSrc.rowsPerImage=sze.at(1,1);
videoFrmBfrSrc.buffer=wb.at(3,3);
// videoFrmBfrDst.bytesPerRow=(floor((sze.at(0,0)*4)/256)+1)*256;
