...
depthAttachment.stencilLoadOp=WGPU_LOAD_OP_UNDEFINED;
...
// config.alphaMode=WGPU_CANVAS_ALPHA_MODE_INVALID;
config.alphaMode=WGPU_CANVAS_ALPHA_MODE_PREMULTIPLIED;
// config.alphaMode=WGPU_CANVAS_ALPHA_MODE_OPAQUE;
config.colorSpace=HTML_PREDEFINED_COLOR_SPACE_INVALID;
