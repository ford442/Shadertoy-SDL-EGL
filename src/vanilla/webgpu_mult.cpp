...
textureDescriptorInVmult.usage=WGPU_TEXTURE_USAGE_RENDER_ATTACHMENT|WGPU_TEXTURE_USAGE_TEXTURE_BINDING|WGPU_TEXTURE_USAGE_COPY_DST;
...
WGPU_TextureDescriptor.at(0,0,4)=textureDescriptorInMult;
WGPU_TextureDescriptor.at(0,0,5)=textureDescriptorInVmult;
...
videoTextureDescriptor.usage=WGPU_TEXTURE_USAGE_RENDER_ATTACHMENT|WGPU_TEXTURE_USAGE_TEXTURE_BINDING|WGPU_TEXTURE_USAGE_STORAGE_BINDING|WGPU_TEXTURE_USAGE_COPY_DST;
...
Compute_Bindgroup_Layout_Entries[2].layout.texture=wtbl.at(3,3);
...
Compute_Bindgroup_Layout_Entries[8].layout.texture=wtbl.at(3,3);
...
Compute_Bindgroup_Entries[2].resource=wtv.at(7,7);
          // Compute Output Texture
...
fragState2.targets=&colorTarget32;
...
renderPipelineDesc.multisample=multiSamp3;
...
Resolve_Bindgroup_Entries[2].resource=wtv.at(2,2);
  //  Resolve iResolution Buffer
...
Resolve_Bindgroup_Entries_2[2].resource=wtv.at(2,2);
  //  Resolve iResolution Buffer
