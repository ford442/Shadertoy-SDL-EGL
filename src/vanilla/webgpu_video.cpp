...
// wgpu_queue_write_texture(wq.at(0,0),&wict.at(0,0),buffer_ptr,sze.at(0,0)*32,sze.at(0,0)*sze.at(0,0)*32,sze.at(0,0),sze.at(0,0),1);
    */
wgpu_queue_write_texture(wq.at(0,0),&wict.at(0,0),js_data_pointer.at(0,0),(sze.at(0,0)*32),(sze.at(0,0)*sze.at(0,0)*32),sze.at(0,0),sze.at(0,0),1);
...
videoTextureDescriptor.dimension=WGPU_TEXTURE_DIMENSION_2D;
WGPU_TEXTURE_FORMAT videoViewFormats[1]={wtf.at(2,2)};
