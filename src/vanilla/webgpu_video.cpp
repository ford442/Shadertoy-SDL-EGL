...
videoTextureDescriptor.width=800; // sze.at(0,0);
videoTextureDescriptor.height=800; // sze.at(0,0); // default = 1;
...
depthTextureDescriptor.width=800; // sze.at(0,0);
depthTextureDescriptor.height=800; // sze.at(0,0); // default = 1;
...
colorTextureDescriptor.width=800; // sze.at(0,0);
colorTextureDescriptor.height=800; // sze.at(0,0); // default = 1;
