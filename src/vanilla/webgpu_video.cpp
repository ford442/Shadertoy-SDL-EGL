...
videoSamplerDescriptor.magFilter=WGPU_FILTER_MODE_INVALID; // WGPU_FILTER_MODE_LINEAR;
videoSamplerDescriptor.minFilter=WGPU_FILTER_MODE_INVALID; // WGPU_FILTER_MODE_LINEAR;
videoSamplerDescriptor.mipmapFilter=WGPU_MIPMAP_FILTER_MODE_INVALID; // WGPU_MIPMAP_FILTER_MODE_LINEAR;
