...
wgpu_queue_write_texture(wq.at(0,0),&wict.at(0,0),&data,sze.at(0,1)*4,sze.at(1,0),sze.at(0,1),sze.at(1,0),1);
...
u64_bfrSze.at(0,0)=sze.at(1,0)*sze.at(0,1);
...
videoTextureDescriptor.width=sze.at(0,1);
videoTextureDescriptor.height=sze.at(1,0); // default = 1;
