...
wgpu_render_pass_encoder_set_viewport(wrpe.at(0,0),0.0,0.0,1111,1111,0.0,1.0);
...
bufferDescriptorU.size=sizeof(WGpuUniform);
bufferDescriptorU.usage=WGPU_BUFFER_USAGE_UNIFORM|WGPU_BUFFER_USAGE_COPY_DST;
bufferDescriptorU.mappedAtCreation=EM_FALSE;
...
WGpuPipelineLayout pipeline_layout=wgpu_device_create_pipeline_layout(wd.at(0,0),&bindgroup_layout,1);
