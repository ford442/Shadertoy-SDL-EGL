...
renderPassTimestampWrite.beginningOfPass=true;
renderPassTimestampWrite.endOfPass=true;
timestampWrites.count=1;
timestampWrites.writes=&renderPassTimestampWrite;
renderPassTimestampWrite.querySet=TquerySet;
