...
renderBundleEncoderDescriptor.depthStencilFormat=WGPU_TEXTURE_FORMAT_DEPTH32_STENCIL8;
...
sze.at(0,0)=szh;
sze.at(0,1)=szw;
depthTextureViewDescriptor.format=WGPU_TEXTURE_FORMAT_DEPTH32_STENCIL8;
...
depthTextureDescriptor.format=WGPU_TEXTURE_FORMAT_DEPTH32_STENCIL8;
...
depthTextureDescriptor.dimension=WGPU_TEXTURE_DIMENSION_2D;
WGPU_TEXTURE_FORMAT depthViewFormats[1]={WGPU_TEXTURE_FORMAT_DEPTH32_STENCIL8};
