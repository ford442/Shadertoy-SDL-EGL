...
"fragColor_1=vec4<f32>(0.0,0.733,0.723,1.0);\n"
...
passDesc.depthStencilAttachment=wrpdsa.at(1,1);
...
*/   //  Render Pass
wceA=wgpu_device_create_command_encoder_simple(wd.at(0,0));
wce.at(0,0)=wceA;
...
wceA={};
wceB=wgpu_device_create_command_encoder_simple(wd.at(0,0));
wce.at(1,1)=wceB;
...
u64_bfrSze.at(1,1)=(floor((sze.at(1,1)*4)/256)+1)*256;
...
depthState2.format=WGPU_TEXTURE_FORMAT_DEPTH32FLOAT_STENCIL8;
...
renderPipelineDesc2.depthStencil=depthState2;
