...
"for(var x:u32=0u;x<inSizeU;x=x+1u){\n"
"var xPos:u32=u32(f32(x)*sizeRatio);\n"
"for(var y:u32=0u;y<inSizeU;y=y+1u){\n"
...
wgpu_queue_write_buffer(wq.at(0,0),wb.at(1,1),0,&u64_uni.at(2,2),sizeof(uint64_t));
...
u64_siz.at(0,0)=szhI*2;
sze.at(0,0)=int(szhI);
sze.at(1,1)=int(szhI)*2;
...
Render_Bindgroup_Entries[3].resource=wb.at(0,0);
