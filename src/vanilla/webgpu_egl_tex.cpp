...
"var loopSize:u32=max(outSizeU,inSizeU);\n"
"for(var x:u32=0u;x<=loopSize;x=x+1u){\n"
"var xPos:u32=u32(round((f32(x))*sizeRatio));\n"
"for(var y:u32=0u;y<=loopSize;y=y+1u){\n"
...
// "color.r+=0.0000000001f;\n"
// "color.g+=0.0000000001f;\n"
// "color.b+=0.0000000001f;\n"
