...
"var threadU:u32=thread_id.z-1;\n"
"var threadF:f32=f32(thread_id.z)-1.0f;\n"
"var outSizeU:u32=textureDimensions(videoOUT).x;\n"
"var loopSizeU:u32=textureDimensions(videoOUT).x/2;\n"
"var loopSizeF:f32=f32(textureDimensions(videoOUT).x)/2.0f;\n"
...
"var xPos:u32=u32(round((f32(x)+(loopSizeF*threadF))*sizeRatio));\n"
