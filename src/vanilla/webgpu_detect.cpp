...
u64_bfrSze.at(0,0)=128; // (floor((sze.at(0,0))/256)+1)*256;
u64_bfrSze.at(1,1)=128; // (floor((sze.at(1,1))/256)+1)*256;
originXYZ.x=0;
originXYZ.y=0;
originXYZ.z=0;
originXY.x=0;
...
textureDescriptorBfr.width=128;
...
wict.at(3,3)=Output_Image_Texture2;
  ...
  wict.at(5,5)=Output_Image_Texture_Bfr;
