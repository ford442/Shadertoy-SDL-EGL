...
// "let sizeIN=<u32>inputBuffer[0];\n" // =textureDimensions(textureIN,0);\n"
// "let sizeOUT=<u32>inputBuffer[1];\n"
"for(var y=0u;y<inputBuffer[1];y++){\n"
"for(var x=0u;x<inputBuffer[1];x++){\n"
"if(x*y<=inputBuffer[1]*inputBuffer[1]){\n"
"let INtexCoord:vec2<f32>=vec2<f32>(x,y)/vec2<f32>(inputBuffer[0]);\n"
...
wgpu_command_encoder_copy_texture_to_texture(wrpe.at(0,0),&wict.at(2,2),&wict.at(0,0),sze.at(0,0),sze.at(0,0),1);
*/
