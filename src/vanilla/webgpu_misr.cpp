...
"var INtexCoord:vec2<u32>=uvec2<u32>(x,y)/uvec2<u32>(sizeINu.x,sizeINu.y);\n"
// "var color:vec4<f32>=textureLoad(textureIN,INtexCoord,0);\n"
"var color:vec4<f32>=textureLoad(textureIN,uvec2<u32>(42,42),0);\n"
...
"textureStore(textureOUT,uvec2<u32>(42,42),color);\n"
// "}"
"}"
"}"
"}";
