...
"for(var y=0u;y<<u32>(inputBuffer[1]);y++){\n"
"for(var x=0u;x<<u32>(inputBuffer[1]);x++){\n"
"if(x*y<=<u32>(inputBuffer[1])*<u32>(inputBuffer[1])){\n"
"let INtexCoord:vec2<f32>=vec2<f32>(x,y)/vec2<f32>(sizeIN);\n"
