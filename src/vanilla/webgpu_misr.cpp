...
"let color32u:vec4<u32>=clamp(vec4<u32>(round(color*255.0)),vec4<u32>(0u,0u,0u,0u),vec4<u32>(255u,255u,255u,255u));\n"
"textureStore(textureOUT,vec2<u32>(u32(x),u32(y)),uvec4<u32>(color32u));\n"
// "}"
"}"
"}"
"}";
