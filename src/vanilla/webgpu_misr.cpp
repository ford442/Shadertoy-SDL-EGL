...
"let sizeIN:f32=inputBuffer[0];\n" // =textureDimensions(textureIN,0);\n"
"let sizeOUT:f32=inputBuffer[1];\n"
"for(var y=0.0f;y<sizeOUT;y++){\n"
"for(var x=0.0f;x<sizeOUT;x++){\n"
"if(x*y<=sizeOUT*sizeOUT){\n"
"let INtexCoord:vec2<f32>=vec2<f32>(x,y)/vec2<f32>(sizeIN,sizeIN);\n"
