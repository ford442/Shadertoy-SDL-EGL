...
std::array<WGpuVertexAttribute,2>vertAttArray={vertAtt,vertAtt2};
vertBufLayout.numAttributes=2;
vertBufLayout.attributes=std::array<WGpuVertexAttribute,2>vertAttArray={vertAtt,vertAtt2}; // vertAttArray.data(); // vertAttArray;
