...
// std::vector<uint64_t> data((std::istreambuf_iterator<char>(fram)),(std::istreambuf_iterator<char>()));
std::vector<GLubyte> data((std::istreambuf_iterator<char>(fram)),(std::istreambuf_iterator<char>()));
// frame_tensor.at(0,0)=data;
// fjs_data_pointer.at(0,0)=data;
...
wgpu_queue_write_texture(WGPU_Queue.at(0,0,0),&wict.at(4,4),&frame_tensorGL.at(0,0),sze.at(6,6)*4,sze.at(7,7),sze.at(6,6),sze.at(7,7),1);
  //  Render Pass
