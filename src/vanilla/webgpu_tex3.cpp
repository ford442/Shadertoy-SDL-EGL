...
u_time.time_spana=boost::chrono::duration<boost::compute::double_,boost::chrono::seconds::period>(u_time.t2-u_time.t3);
if(float(u_time.time_spana.count()/1000)>=17.0f){
