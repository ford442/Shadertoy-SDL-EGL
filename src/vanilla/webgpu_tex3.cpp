...
wgpu_render_pass_encoder_set_vertex_buffer(wrpe.at(0,0),0,wb.at(6,6),0,sizeof(FUVvertices));
...
wgpu_render_pass_encoder_set_vertex_buffer(wrpe.at(1,1),0,wb.at(6,6),0,sizeof(FUVvertices));
...
vertBufLayout.arrayStride=sizeof(FUVertex);
