...
v4f32_uniform.at(0,0)=vector<float, boost::numeric::ublas::bounded_array<float, 4>>({static_cast<float>(mms.at(2,0)),static_cast<float>(mms.at(2,1)),static_cast<float>(mms.at(0,1)),static_cast<float>(mms.at(1,0))});
