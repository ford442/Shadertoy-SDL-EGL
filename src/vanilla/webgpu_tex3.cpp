...
// f32_uniform.at(0,0)=float(u_time.time_spana.count())*100000.0f;
...
sze.at(0,0)=int(szhI);
sze.at(3,3)=int(std::max(sze.at(0,0),sze.at(1,1))*1.07);
...
Render_Bindgroup_Layout_Entries[2].layout.texture=wtbl.at(3,3);
