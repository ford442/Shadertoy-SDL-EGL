...
"var loopx:u32=u32(inputBuffer[1]);\n"
"var loopy:u32=u32(inputBuffer[1]);\n"
...
"outputBuffer[1]=outputBuffer[1];\n"
"for(var y:u32=0u;y<loopx;y=y+1u){\n"
"for(var x:u32=0u;x<loopy;x=x+1u){\n"
...
// "outputBuffer[1]=outputBuffer[1]+1.0;\n"
