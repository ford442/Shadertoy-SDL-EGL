...
wgpu_command_encoder_copy_buffer_to_texture(WGPU_CommandEncoder.at(0,0,0),&wicb.at(2,2),&wict.at(0,0),sze.at(0,0),sze.at(0,0),1);
...
// videoFrmBfrDst.bytesPerRow=dstBuffer;
// videoFrmBfrDst.rowsPerImage=dstBuffer;
