...
"if (coords.x < i32(textureOUT.get_dimensions(0).x) &&\n"
"coords.y < i32(textureOUT.get_dimensions(0).y)) { \n"
"let color = vec4<f32>(coords.x / float(textureOUT.get_dimensions(0).x), \n"
"coords.y / float(textureOUT.get_dimensions(0).y), \n"
"0.0, 1.0);\n"
