...
WGpuCommandEncoder wceC={};
WGpuCommandEncoder wceD={};
...
WGpuRenderPassColorAttachment multiOUTVattachment={};
...
WGpuSamplerDescriptor videoSamplerMultDescriptor={};
...
WGpuRenderPassDescriptor passDesc3={};
WGpuRenderPassDescriptor passDesc4={};
...
WGpuBindGroupLayout bindgroup_layout_3=0;
WGpuBindGroupLayout bindgroup_layout_4=0;
WGpuBindGroupLayoutEntry Render_Bindgroup_Layout_Entries[8]={};
WGpuBindGroupLayoutEntry Resolve_Bindgroup_Layout_Entries[8]={};
WGpuBindGroupLayoutEntry Render_Bindgroup_Layout_Entries_2[8]={};
WGpuBindGroupLayoutEntry Resolve_Bindgroup_Layout_Entries_2[8]={};
WGpuBindGroupEntry Render_Bindgroup_Entries[8]={};
WGpuBindGroupEntry Render_Bindgroup_Entries_2[8]={};
WGpuBindGroupEntry Resolve_Bindgroup_Entries[8]={};
WGpuBindGroupEntry Resolve_Bindgroup_Entries_2[8]={};
...
WGpuMultisampleState multiSamp3={};
...
wbgl_tensor wbgl=wbgl_tensor{4,4};
wbg_tensor wbg=wbg_tensor{4,4};
wrpd_tensor wrpd=wrpd_tensor{4,4};
wrpca_tensor wrpca=wrpca_tensor{4,4};
...
wrbe_tensor wrbe=wrbe_tensor{4,4};
wrbed_tensor wrbed=wrbed_tensor{4,4};
wrpdsa_tensor wrpdsa=wrpdsa_tensor{4,4};
...
WGpuTextureDescriptor textureDescriptorInMult={};
WGpuTextureDescriptor textureDescriptorInV={};
WGpuTextureDescriptor textureDescriptorInVmult={};
...
WGpuTextureViewDescriptor textureViewDescriptorInMult={};
WGpuTextureViewDescriptor textureViewDescriptorInV={};
WGpuTextureViewDescriptor textureViewDescriptorInVmult={};
...
WGpuImageCopyTexture Input_Image_TextureMult={};
WGpuImageCopyTexture Input_Image_TextureV={};
WGpuImageCopyTexture Input_Image_TextureVmult={};
