...
WGpuTextureViewDescriptor videoAttachmentTextureViewDescriptor={};
...
WGpuTexture videoAttachmentTexture;
...
WGpuTextureDescriptor videoAttachmentTextureDescriptor={};
...
static wetd_tensor wetd=wetd_tensor{3,3};
static wet_tensor wet=wet_tensor{3,3};
static i_tensor texid=i_tensor{3,3};
static i_tensor sze=i_tensor{3,3};
static f_tensor szef=f_tensor{3,3};
static wce_tensor wce=wce_tensor{3,3};
static wrpe_tensor wrpe=wrpe_tensor{3,3};
static wcb_tensor wcb=wcb_tensor{3,3};
static wd_tensor wd=wd_tensor{3,3};
static wq_tensor wq=wq_tensor{3,3};
static wa_tensor wa=wa_tensor{3,3};
static wcc_tensor wcc=wcc_tensor{3,3};
static wccf_tensor wccf=wccf_tensor{3,3};
static wrp_tensor wrp=wrp_tensor{3,3};
static wrpl_tensor wrpl=wrpl_tensor{3,3};
static wb_tensor wb=wb_tensor{5,5};
static wbgle_tensor wbgle=wbgle_tensor{3,3};
static wbge_tensor wbge=wbge_tensor{3,3};
static wbgl_tensor wbgl=wbgl_tensor{3,3};
static wbg_tensor wbg=wbg_tensor{3,3};
static wrpd_tensor wrpd=wrpd_tensor{3,3};
static wrpca_tensor wrpca=wrpca_tensor{3,3};
static wbbl_tensor wbbl=wbbl_tensor{3,3};
static wsbl_tensor wsbl=wsbl_tensor{3,3};
static wbd_tensor wbd=wbd_tensor{5,5};
static wao_tensor wao=wao_tensor{3,3};
static wdd_tensor wdd=wdd_tensor{3,3};
static u64_tensor u64_uni=u64_tensor{4,4};
static u64_tensor u64_siz=u64_tensor{4,4};
static wrbe_tensor wrbe=wrbe_tensor{3,3};
static wrbed_tensor wrbed=wrbed_tensor{3,3};
static wrpdsa_tensor wrpdsa=wrpdsa_tensor{3,3};
...
static wicei_tensor wicei=wicei_tensor{3,3};
static js_tensor js_data_pointer=js_tensor{3,3};
static u64_tensor u64_bfrSze=u64_tensor{4,4};
static wict_tensor wict=wict_tensor{4,4};
static wsd_tensor wsd=wsd_tensor{3,3};
static ws_tensor ws=ws_tensor{3,3};
static v_tensor imgData=v_tensor{3,3};
...
wtv.at(2,2)=videoTextureView;
  videoTextureView=wgpu_texture_create_view(wt.at(3,3),&wtvd.at(3,3));
wtv.at(3,3)=videoTextureView;
...
videoAttachmentTextureDescriptor.mipLevelCount=1;
videoAttachmentTextureDescriptor.sampleCount=1;
videoAttachmentTextureDescriptor.dimension=WGPU_TEXTURE_DIMENSION_2D;
WGPU_TEXTURE_FORMAT videoAttachmentViewFormats[1]={wtf.at(0,0)};
videoAttachmentTextureDescriptor.numViewFormats=0; // &videoViewFormats[0];
videoAttachmentTextureDescriptor.viewFormats=nullptr; // &videoAttachmentViewFormats[0];
