...
wtv.at(2,2)=videoTextureView;
  ...
  videoTextureAttachmentDescriptor.dimension=WGPU_TEXTURE_DIMENSION_2D;
videoTextureAttachmentDescriptor.format=wtf.at(0,0);
videoTextureAttachmentDescriptor.usage=WGPU_TEXTURE_USAGE_RENDER_ATTACHMENT;
videoTextureAttachmentDescriptor.width=sze.at(0,0);
videoTextureAttachmentDescriptor.height=sze.at(0,0); // default = 1;
videoTextureAttachmentDescriptor.depthOrArrayLayers=1;
videoTextureAttachmentDescriptor.mipLevelCount=1;
videoTextureAttachmentDescriptor.sampleCount=1;
videoTextureAttachmentDescriptor.dimension=WGPU_TEXTURE_DIMENSION_2D;
WGPU_TEXTURE_FORMAT videoAttachmentViewFormats[1]={wtf.at(0,0)};
videoTextureAttachmentDescriptor.numViewFormats=1; // &videoViewFormats[0];
videoTextureAttachmentDescriptor.viewFormats=&videoAttachmentViewFormats[0];
wtd.at(3,3)=videoTextureAttachmentDescriptor;
