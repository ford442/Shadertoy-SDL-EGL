...
emscripten_webgl_enable_extension(ctx.at(0,0),"EGL_HI_colorformats");
emscripten_webgl_enable_extension(ctx.at(0,0),"EGL_EXT_pixel_format_float");
emscripten_webgl_enable_extension(ctx.at(0,0),"EGL_KHR_gl_colorspace");
emscripten_webgl_enable_extension(ctx.at(0,0),"GL_ALL_EXTENSIONS");
emscripten_webgl_enable_extension(ctx.at(0,0),"GL_KHR_no_error");
emscripten_webgl_enable_extension(ctx.at(0,0),"GL_REGAL_enable");
emscripten_webgl_enable_extension(ctx.at(0,0),"EGL_ANGLE_platform_angle");
emscripten_webgl_enable_extension(ctx.at(0,0),"EGL_EXT_gl_colorspace_display_p3_linear");
emscripten_webgl_enable_extension(ctx.at(0,0),"GL_ARB_ES2_compatibility");
emscripten_webgl_enable_extension(ctx.at(0,0),"GL_ARB_direct_state_access");
