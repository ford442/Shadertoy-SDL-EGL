...
wgpu_queue_write_buffer(wq.at(0,0),wb.at(5,5),0,&u64_siz.at(3,3),sizeof(uint64_t));
...
u64_siz.at(3,3)=sze.at(0,0);
sze.at(0,0)=int(szhI);
u64_siz.at(2,2)=sze.at(1,1);
...
textureDescriptorIn.dimension=WGPU_TEXTURE_DIMENSION_2D;
textureAviewFormats[0]={wtf.at(0,0)};
...
#include "../../src/vanilla/webgpu_compute_js_gpu2.cpp"
