...
constexpr int inSiz=vectorProduct(inputDims);
std::array<Ort::Value,inSiz> inputTensors;
...
let highRes=document.querySelector('#resMode').value;
                       //  get onnx model  //
document.querySelector('#path').innerHTML='https://1ink.us/files/gptneox_Opset18.onnx';
