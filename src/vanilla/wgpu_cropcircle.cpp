...
document.querySelector('#imag').height=parseInt(window.innerHeight,10);
document.querySelector('#imag2').height=parseInt(window.innerHeight,10);
document.querySelector('#imag').width=parseInt(window.innerHeight,10);
document.querySelector('#imag2').width=parseInt(window.innerHeight,10);
