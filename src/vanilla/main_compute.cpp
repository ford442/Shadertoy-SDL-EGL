...
// wgpu_command_encoder_copy_texture_to_buffer(wrpe.at(0,0),&WGPU_Output_Image,&wb.at(3,3),1,64,1);
wgpu_command_encoder_copy_buffer_to_buffer(wrpe.at(0,0),WGPU_Buffers.at(2,0,2),0,wb.at(3,3),0,sizeof(vertices));
