...
// wgpu_object_destroy(WGPU_Buffers.at(2,0,2));
    wgpu_command_encoder_copy_buffer_to_texture(WGPU_CommandEncoder.at(0,0,2),&WGPU_Output_Buffer,&WGPU_Output_Image,1,1,1);
wgpu_command_encoder_copy_texture_to_buffer(WGPU_CommandEncoder.at(0,0,2),&WGPU_Output_Image,&WGPU_Mapped_Buffer,1,1,1);
