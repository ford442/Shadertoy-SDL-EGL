...
unsigned int uintOutputBufferSize=1048576;
int intOutputBufferSize=1048576;
unsigned int uintInputBufferSize=1048576;
int intInputBufferSize=1048576;
...
// NO ARRAY  / NO CRASH
double_int53_t Range=wgpu_buffer_get_mapped_range(WGPU_Buffers.at(1,0,1),0,uintOutputBufferSize);
...
raN=rNd4(1024);
    unsigned int * mm=&WGPU_Input_Array[0];
mm[0]=raN;
...
wgpu_queue_write_buffer(WGPU_Queue.at(0,0,0),WGPU_Buffers.at(1,1,1),0,WGPU_Input_Array,262144);
