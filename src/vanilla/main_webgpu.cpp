...
std::vector<int>input(uintInputBufferSize/sizeof(unsigned int));
std::vector<int>outputd(uintOutputBufferSize/sizeof(unsigned int));
...
// WGPU_ResultBuffer.at(0,0,0)=&outputd;
 ...
 wgpu_buffer_read_mapped_range(WGPU_Buffers.at(1,0,1),Range,0,locate,uintOutputBufferSize);
