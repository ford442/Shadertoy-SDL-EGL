...
// NO ARRAY  / NO CRASH
      double Range=wgpu_buffer_get_mapped_range(WGPU_Buffers.at(1,0,1),0,262144*4);
...
// WGPU_ResultBuffer.at(0,0,0)=&outputd;
 ...
 wgpu_buffer_read_mapped_range(WGPU_Buffers.at(1,0,1),0,0,locate,262144*4);
         std::cout << &locate[0] << std::endl;
...
// GOT ARRAY  / CRASH
double WGPU_Map_Range=wgpu_buffer_get_mapped_range(WGPU_Buffers.at(1,0,1),0,262144);
