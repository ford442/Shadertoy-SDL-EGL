...
WGpuStorageTextureBindingLayout WGpuStorageTextureBindingLayout1={1,WGPU_TEXTURE_FORMAT_R32FLOAT,WGPU_TEXTURE_DIMENSION_2D};
...
// WGPU_TextureView.at(0,0,0)=wgpu_texture_create_view(WGPU_Texture.at(0,0,0),&WGPU_TextureViewDescriptor.at(0,0,0));
   // WGPU_TextureView.at(0,0,0)=wgpu_texture_create_view(WGPU_Texture.at(0,0,0));
