...
"let clr:vec4f<f32>=textureLoad(textureA:texture_storage_2d<f32>,coord,0);"
// "let flt:u32=u32(clr:f32);"
   // "textureStore(textureA,coord,vec4f(0.42,0.0,0.0,1.0));"
"outputBuffer[f]=42;"
"}";
...
WGpuStorageTextureBindingLayout storageTextureBindingLayout1={1,14,2};
...
// 14 = R32FLOAT
WGpuTextureDescriptor textureDescriptorA={256,256,1,1,1,WGPU_TEXTURE_DIMENSION_2D,14,WGPU_TEXTURE_USAGE_STORAGE_BINDING|WGPU_TEXTURE_USAGE_COPY_SRC|WGPU_TEXTURE_USAGE_COPY_DST};
