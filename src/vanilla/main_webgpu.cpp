...
// NO ARRAY  / NO CRASH
uint64_t Range=wgpu_buffer_get_mapped_range(WGPU_Buffers.at(1,0,1),0,262144);
...
// WGPU_ResultBuffer.at(0,0,0)=&outputd;
 ...
 wgpu_buffer_read_mapped_range(WGPU_Buffers.at(1,0,1),Range,0,locate,262144);
         std::cout << &locate << std::endl;
...
// GOT ARRAY  / CRASH
uint32_t WGPU_Map_Range=wgpu_buffer_get_mapped_range(WGPU_Buffers.at(1,0,1),0,262144);
