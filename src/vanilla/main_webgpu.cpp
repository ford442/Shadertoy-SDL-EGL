...
unsigned long long bufferMapSize=262144*sizeof(unsigned int);
unsigned long long ibufferMapSize=1*sizeof(unsigned int);
int ibufferSize=1*sizeof(unsigned int);
unsigned long long DescriptorBufferSize=262144*sizeof(unsigned int);
unsigned long long iDescriptorBufferSize=1*sizeof(unsigned int);
