...
var $4=new Float32Array(W4.buffer,0,l/16);
var $5=new Float32Array(W5.buffer,0,l/16);
var $6=new Float32Array(W6.buffer,0,l/16);
var $7=new Float32Array(W7.buffer,0,l/16);
var $8=new Float32Array(W8.buffer,0,l/16);
var T=false;
...
console.log(new Float32Array.of(lln));
console.log("normal");
console.log(ffg);
console.log("toarray");
