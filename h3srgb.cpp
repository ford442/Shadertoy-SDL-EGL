...
gl.blendFuncSeparate(gl.DST_COLOR,gl.SRC_COLOR,gl.DST_COLOR,gl.ONE_MINUS_SRC_ALPHA);
...
glBlendFuncSeparate(GL_DST_COLOR,GL_SRC_COLOR,GL_SRC_COLOR,GL_ONE_MINUS_SRC_ALPHA);
