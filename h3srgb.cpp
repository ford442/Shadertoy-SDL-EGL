...
contx.getExtension('WEBGL_multi_draw_instanced_base_vertex_base_instance');
contx.getExtension('WEBGL_draw_instanced_base_vertex_base_instance');
...
emscripten_webgl_enable_extension(ctx,"WEBGL_multi_draw_instanced_base_vertex_base_instance");
emscripten_webgl_enable_extension(ctx,"WEBGL_draw_instanced_base_vertex_base_instance");
