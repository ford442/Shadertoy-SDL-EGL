...
static const unsigned wchar_t common_shader_header_gles3[]=
"#version 300 es \n precision highp float;precision highp int;precision mediump sampler3D;precision highp sampler2D;";
static const unsigned wchar_t vertex_shader_body_gles3[]=
"\n layout(location=0)in vec4 iPosition;void main(){gl_Position=iPosition;}\n\0";
static const unsigned wchar_t fragment_shader_header_gles3[]=
"\n uniform vec3 iChannelResolution;uniform vec3 iResolution;uniform float iTime;uniform vec4 iMouse;"
"uniform sampler2D iChannel0;uniform sampler2D iChannel1;uniform sampler2D iChannel2;uniform sampler2D iChannel3;"
"out vec4 fragColor;\n";
static const unsigned wchar_t fragment_shader_footer_gles3[]=
"\n void main(){mainImage(fragColor,gl_FragCoord.xy);}\n\0";
static const unsigned wchar_t* common_shader_header=common_shader_header_gles3;
static const unsigned wchar_t* vertex_shader_body=vertex_shader_body_gles3;
...
static const char8_t *read_file(const unsigned wchar_t *filename){
...
static GLuint compile_shader(GLenum type,GLsizei nsources,const unsigned wchar_t **dsources){
...
static const unsigned wchar_t* default_fragment_shader=(unsigned wchar_t*)read_file(fileloc);
