...
var glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g){return (1.0-b)-(((((1.0-f)-(a)+b)*1.5)/2.0)+((f-0.5)*((1.0-f)*0.25))-((0.5-f)*(e*0.25))+((g-0.7)*(f*0.01)));}`;
...
var alph=Alphe($amax,$amin,$fmax,$fmin,$favg,$aavg);
