...
var locb=$Bu+1;
if(locb>64){locb=1;}
  var tEst=Math.random()*12+i;
// eval("if ($F=="+i+"){var $r"+i+"=t($"+i+");r($r"+i+");var $$"+$Bu+"=t(vv);$"+$Bu+".set($$"+$Bu+");$F="+loca+";$Bu="+locb+";}");
eval("if ($F=="+tEst+"){var $r"+tEst+"=t($"+tEst+");r($r"+tEst+");var $$"+$Bu+"=t(vv);$"+$Bu+".set($$"+$Bu+");$F="+loca+";$Bu="+locb+";}");
}
