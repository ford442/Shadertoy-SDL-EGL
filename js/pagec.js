...
$iwid.innerHTML=1080; // parseInt($w,10);
...
// document.querySelector('#wid').innerHTML=parseInt(window.innerHeight,10);
// document.querySelector('#hig').innerHTML=parseInt(window.innerHeight,10);
