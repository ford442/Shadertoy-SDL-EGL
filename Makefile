...
COMMON_FLAGS += -sDISABLE_EXCEPTION_CATCHING=1 -O3 -fmerge-all-constants -ffast-math -ffp-contract=off -mnontrapping-fptoint -fno-stack-protector \
...
b3_shader_webgpu:
	 ...
	 em++ -std=c++14 -c src/shader/shader_webgpu.cpp -framework OpenGL $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS) -DDOUBLE
