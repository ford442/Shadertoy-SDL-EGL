...
COMMON_FLAGS += -pipe -sUSE_PTHREADS=1 -pthread -sPROXY_TO_PTHREAD=1 -sSHARED_MEMORY=1 -sDISABLE_EXCEPTION_CATCHING=1 -fPIC -fpie -finline-functions -funroll-loops -fno-rtti \
