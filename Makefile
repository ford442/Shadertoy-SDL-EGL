...
b3_vanilla_llvm:
	 em++ src/vanilla/main.cpp -c -I/usr/include/mpd.h -sUSE_BOOST_HEADERS=1 -std=c++17 -stdlib=libc++ -flto=thin -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
