...
tst8b: egl4b.cpp  Makefile
	emcc egl4b.cpp -std=c++2b -sUSE_SDL=2 -O3 -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1  -flto=thin -sENVIRONMENT=web \
-sUSE_WEBGL2=1 -sENVIRONMENT=web -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=1 -sFORCE_FILESYSTEM=1 \
