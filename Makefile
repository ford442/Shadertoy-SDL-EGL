...
b3_shader:
	 em++ src/shader/shader.cpp -c -std=c++2a  -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx
	 em++ src/shader/main.cpp -c -std=c++11
	 em++ shader.o main.o -o s3020.js -std=c++2a  -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx \
