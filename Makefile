...
b3_vanilla_webgpu:
	 em++ src/vanilla/main_webgpu.cpp lib/lib_webgpu_cpp20.cpp lib/lib_webgpu.cpp -c -sUSE_BOOST_HEADERS=1 -std=gnu17 -std=gnu++20 -stdlib=libc++ -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
