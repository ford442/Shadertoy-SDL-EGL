LDFLAGS += -Wl,-O3,--lto-O3,--stack-first,-lg,-lc,-lc++,-lm,-lpthread,-lrt,-ldl,-lanl
...
COMMON_FLAGS += -sDISABLE_EXCEPTION_CATCHING=1 -isystem -fPIC -fPIE -finline-functions -funroll-loops -fno-rtti -flto=thin \
...
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -Wl,-lOpenGL
