...
GL_FLAGS += -sFULL_ES3=1 -sFULL_ES2=0 -sLEGACY_GL_EMULATION=1 -lGL -lEGL -sUSE_GLFW=0 -sUSE_REGAL=0 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 -sGL_MAX_TEMP_BUFFER_SIZE=262144 \
