b3_shader_llvm:
	 ...
	 -sASSERTIONS=0 -s DYLINK_DEBUG=0 -fwhole-program -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sGL_UNSAFE_OPTS=0 \
...
b3_combine_dev:
	 ...
	 -fwhole-program -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sDYNAMIC_EXECUTION=0 -sGL_UNSAFE_OPTS=0 \
