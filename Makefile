...
b3_compute_egl_tex3:
	 ...
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -c $(BOOST_FLAGS) $(SIMD_FLAGS)
	 em++ -O2 -mextended-const -dead_strip -mbulk-memory -matomics -std=c++20 -pipe \
	 -ffast-math -ffp-contract=off -sENVIRONMENT='web' -sGLOBAL_THIS=window \
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_startWebGPUi","_startWebGPUbi","_frmOn","_global","_window"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
