b3hd:
	 em++ src/b3main.cpp -c \
         -fno-math-errno -std=gnu++2a -stdlib=libstdc++-8 -mcpu=bleeding-edge -fwasm-exceptions \
	 -mbulk-memory -msign-ext -m32 -matomics -ffast-math -ffp-contract=fast -freciprocal-math
	 em++ src/b3ogl.cpp -c \
	 -fno-math-errno -std=gnu++2a -stdlib=libstdc++-8 -matomics \
	 ...
	 em++ src/b3sdl.cpp -c \
	 -fno-math-errno -sUSE_SDL=2 -std=gnu++2a -stdlib=libstdc++-8 -matomics -fslp-vectorize \
