LDFLAGS += -Wl,-O3,--lto-O3,--stack-first,-lc,-lc++,-lc++abi,-lm,-lpthreads,-lrt,-ldl,-S
...
COMMON_FLAGS += -pipe -lpthreads -sDISABLE_EXCEPTION_CATCHING=1 -fPIC -fpie -finline-functions -funroll-loops -fno-rtti -flto=thin \
