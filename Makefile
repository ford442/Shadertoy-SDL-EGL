...
b3_vanilla_llvm:
	 em++ src/vanilla/main.cpp -c -O0 -std=gnu++2b -fc++-abi=experimental-mv -emit-llvm
	 emcc src/vanilla/js.c -c -O0 -std=gnu17 -fc++-abi=experimental-mv -emit-llvm
	 emcc main.o js.o -o v3020.js -mllvm -O0 -flto=thin -fc++-abi=experimental-mv -emit-llvm\
