b3hd:
	 ...
	 -mbulk-memory -msign-ext -mmmx -m32 -matomics -ffast-math -ffp-contract=fast -freciprocal-math
	 ...
	 -mmmx -msimd128 -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -mavx2 -m3dnow -m3dnowa -DSIMD=128 \
	 ...
	 -fapprox-func -mbulk-memory -msign-ext -msimd128 -m32 -mmmx -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -DSIMD=128 \
	 ...
	 -DSIMD=128 -mmmx -fuse-ld=mold -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
