b3hd:
	 ...
	 em++ src/b3sdl.cpp -c \
	 -sUSE_SDL=2 -std=gnu++2a -matomics -fslp-vectorize \
	 ...
	 -std=gnu++2a -mcpu=bleeding-edge -fwasm-exceptions -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
