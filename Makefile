...
COMMON_FLAGS += -sWASM_WORKERS=1 -sSHARED_MEMORY=1 -sWASMFS=1 -pthread -sPTHREAD_POOL_SIZE=2 -sDISABLE_EXCEPTION_CATCHING=1 -Og -fmerge-all-constants -ffast-math -ffp-contract=off -fno-stack-protector \
...
GL_FLAGS += -sOFFSCREEN_FRAMEBUFFER=1 -sFULL_ES3=1 -sFULL_ES2=1 -sGL_MAX_TEMP_BUFFER_SIZE=4gb -sUSE_GLFW=3 \
-sGL_POOL_TEMP_BUFFERS=0 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 

LINK_FLAGS += $(LDFLAGS) -sPROXY_TO_PTHREAD=1 -DISABLE_EXCEPTION_CATCHING=1 --use-preload-plugins --closure 0 --closureFriendly -mllvm -mtune=haswell \
