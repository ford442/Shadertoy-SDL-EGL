b3hd:
	 ...
	 emcc b3main.o b3ogl.o b3sdl.o b3emjs.o -o g3020.js -O0 -DNDEBUG -sAGGRESSIVE_VARIABLE_ELIMINATION=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
	 -sASSERTIONS=0-sRELOCATABLE=1 -sINCLUDE_FULL_LIBRARY=1 -USE_GLFW=0 -sPRECISE_F32=1 -sWASM_BIGINT=1 -std=c++2a -mcpu=bleeding-edge -fwasm-exceptions \
