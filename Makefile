b3hd:
	 ...
	 emcc b3main.o b3ogl.o b3sdl.o b3emjs.o -o g3020.js -O0 -s AGGRESSIVE_VARIABLE_ELIMINATION=1 -s ELIMINATE_DUPLICATE_FUNCTIONS=1 \
	 -sRELOCATABLE=1 -sINCLUDE_FULL_LIBRARY=1 -USE_GLFW=0 -sDYNAMIC_EXECUTION=0 -sASSERTIONS=0 -sPRECISE_F32=1 -DNDEBUG -sWASM_BIGINT=1 -std=c++2a -mcpu=bleeding-edge -fwasm-exceptions \
