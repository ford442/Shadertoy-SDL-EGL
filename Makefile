...
b3_combine_dev:
	 ...
	 em++ src/combine/combine.cpp -c -O0 -std=c++20 -stdlib=libc++ -flto -fmerge-all-constants -fno-stack-protector -mbulk-memory -fno-math-errno -mcpu=bleeding-edge -fstrict-vtable-pointers -fwhole-program-vtables \
	 -ffp-contract=fast \
	 ...
	 emcc main.o audio.o combine.o -o b3hd002.js -sALLOW_TABLE_GROWTH=1 -ffp-contract=fast -fno-stack-protector -mllvm -O3 -mbulk-memory -fmerge-all-constants -std=c++20 -stdlib=libc++ -sUSE_SDL=2 -flto \
