...
tst8b: egl4b.cpp  Makefile
	em++ egl4b.cpp -std=c++2b -stdlib=libc++ -O3 -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1 \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sFORCE_FILESYSTEM=1 -sOFFSCREEN_FRAMEBUFFER=1 \
-DNDEBUG -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sMALLOC="emmalloc" -sSUPPORT_BIG_ENDIAN=1 \
