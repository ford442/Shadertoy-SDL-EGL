...
COMMON_FLAGS_LINK += -fopenmp -sSUPPORT_LONGJMP=emscripten -pthread -pipe -mextended-const -mbulk-memory -matomics \
...
COMMON_FLAGS += -sDEFAULT_TO_CXX=0 $(COMMON_FLAGS_LINK)
