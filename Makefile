...
COMMON_FLAGS += -clang-path /usr/bin/clang-14 -sDISABLE_EXCEPTION_CATCHING=1 -O3 -fmerge-all-constants -ffast-math -ffp-contract=off -mnontrapping-fptoint -fno-stack-protector \
