...
COMMON_FLAGS += -pipe -sDISABLE_EXCEPTION_CATCHING=1 -isystem -fPIC -fPIE -finline-functions -funroll-loops -fno-rtti -flto=thin \
-mno-tail-call -O2 -m32 -fPIC -fmerge-all-constants -ffast-math -ffp-contract=fast \
...
STATIC_LINK_FLAGS += -sDISABLE_EXCEPTION_CATCHING=1 -flto=thin -mno-tail-call -O3 -fmerge-all-constants -ffast-math -ffp-contract=fast \
-ftree-vectorize -fstrict-vtable-pointers -funsafe-math-optimizations -fno-math-errno -mcpu=bleeding-edge \
-ffunction-sections -fdata-sections -fno-optimize-sibling-calls -fasynchronous-unwind-tables \
-mmutable-globals -mnontrapping-fptoint -msign-ext -fno-omit-frame-pointer
...
GL_FLAGS += -sFULL_ES3=1 -sFULL_ES2=1 -sUSE_GLFW=3 -Wl,-lEGL,-lGL,-lGLESv2 \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 -sGL_TRACK_ERRORS=0 

LINK_FLAGS += $(LDFLAGS) -sWASMFS=0 -sASSERTIONS=0 -fno-except -lpthread -sPTHREAD_POOL_SIZE=64 --use-preload-plugins --closure 0 --closureFriendly \
...
b3_vanilla_webgpu:
	 ...
	 em++ -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 main_webgpu.o libonnxruntime_webassembly.a -sDEMANGLE_SUPPORT=0 -O3 -o w3001.js \
...
b3_shader_webgpu:
	 ...
	 -DLIB_WEBGPU_CPP20 -o s3026.js $(COMMON_FLAGS) $(LINK_SIMD_FLAGS) \
