...
GL_FLAGS += -Wl,-lGL -sFULL_ES3=1 -sFULL_ES2=0 -sUSE_GLFW=0 -sUSE_REGAL=0 -sUSE_SDL=2 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
