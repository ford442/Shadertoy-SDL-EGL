...
LINK_FLAGS += $(LDFLAGS) -sEMULATE_FUNCTION_POINTER_CASTS=1 -sSUPPORT_BIG_ENDIAN=1 -sLZ4=1 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=0 -sIGNORE_MISSING_MAIN=0 -sABORT_ON_WASM_EXCEPTIONS=0 -sDEMANGLE_SUPPORT=0 -sASSERTIONS=2 \
