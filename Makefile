...
GL_FLAGS += -sFULL_ES3=1 -lglfw -lglut -lGL -lGLESv2 -lEGL -lX11 -sRELOCATABLE=1 -sUSE_GLFW=3 -sUSE_REGAL=0 -sUSE_SDL=2 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
...
LINK_FLAGS += $(LDFLAGS) -lpthread -sMALLOC=emmalloc -sOFFSCREENCANVAS_SUPPORT=1 -sTEXTDECODER=0 -sALLOW_TABLE_GROWTH=1 -sEMULATE_FUNCTION_POINTER_CASTS=0 -sSUPPORT_BIG_ENDIAN=1 \
