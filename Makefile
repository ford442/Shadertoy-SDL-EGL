LDFLAGSgl += -Wl,-O3,--lto-O3,--export-memory
...
b3_shader_glsl:
	 ...
	 ###         Link
	 @sh clang12.sh; \
	 emcc main.o shader_glsl.o -o gl001.js $(COMMON_FLAGS) $(LINK_SIMD_FLAGS) $(LDFLAGSgl) \
	 --use-preload-plugins --closureFriendly -Wno-implicit-function-declaration -mmultivalue -mnontrapping-fptoint \
...
b3_combine_dev:
	 ...
	 em++ src/combine/audio.cpp -c -O3 -std=c++20 -stdlib=libc++ -fno-stack-protector -fmerge-all-constants -mbulk-memory -sUSE_SDL=2 -sUSE_SDL_MIXER=2 -flto -fno-fast-math \
	 ...
	 -Wl,--lto-O3,--stack-first,--import-memory,--export-memory -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -sASSERTIONS=2 -s DYLINK_DEBUG=0 \
...
b3_audio:
	...
	emcc main.o audio.o -o a3020.js -mllvm -flto -std=gnu++17 -stdlib=libc++ -ffp-contract=off -mtune=tigerlake -march=corei7-avx -fno-math-errno \
	-fpic -O3 -Xclang -menable-no-nans -Xclang -menable-no-infs -sPRECISE_F32=1 -sTEXTDECODER=1 -mcpu=bleeding-edge \
...
b3_vanilla_llvm:
	 em++ src/vanilla/main.cpp -c -sUSE_BOOST_HEADERS=1 -std=c++17 -stdlib=libc++ -flto -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
	 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 
	 emcc src/vanilla/js.c -c -std=gnu17 -flto -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128
