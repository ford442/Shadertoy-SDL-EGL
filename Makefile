LDFLAGS += -Wl,-O3,--lto-O3,--stack-first,-lc,-lc++,-lc++abi,-lm,-lrt,-ldl,-lpthread,-S
...
COMMON_FLAGS += -pipe -pthread -sWASM_WORKERS=1 -sSHARED_MEMORY=1 -sDISABLE_EXCEPTION_CATCHING=1 -fPIC -fpie -finline-functions -funroll-loops -fno-rtti \
