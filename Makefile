...
b3_compute_eglx:
	 em++ src/vanilla/webgpu_tex_egl.cpp $(STDS) -Wno-padded -sMEMORY64=1 -pipe -ffp-contract=fast -fexcess-precision=fast \
	 ...
	 -ftree-vectorize -fstrict-vtable-pointers -fno-math-errno --target=wasm64 -sMEMORY64=1 -DNDEBUG=1 \
	 -mmutable-globals -mnontrapping-fptoint -msign-ext -fno-omit-frame-pointer \
