...
COMMON_FLAGS += -sWASM_WORKERS=1 -sSHARED_MEMORY=1 -pthread -sDISABLE_EXCEPTION_CATCHING=1 -Og -fmerge-all-constants -ffast-math -ffp-contract=off -fno-stack-protector \
