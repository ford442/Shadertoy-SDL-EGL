...
b3_onnx:
	 ...
	 em++ -D__EMSCRIPTEN__ $(LDFLAGS)  main_onnx.o libonnxruntime_webassembly.a -O0 -g -std=c++17 -fchar8_t --js-library lib/lib_webgpu.js -fPIC -fPIE -DCOMPUTE -o $(WGL_BIN_NAME)-onnx.js \
