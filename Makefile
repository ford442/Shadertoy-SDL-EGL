b3_shader_llvm:
	 ...
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ftree-vectorize -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 emcc src/shader/extern.c -o extern.o -shared -O0 -emit-llvm -std=gnu17
	 emcc main.o shader.o extern.o -o s3021.js -emit-llvm -mllvm -mbulk-memory -fmerge-all-constants -ftls-model=local-exec -fwasm-exceptions -force-vector-width=4 -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno \
