...
b3_vanilla_webgpu:
	 ...
	 emcc src/vanilla/main_render.cpp -I/content/RAMDRIVE2/b3/include/vanilla/ -c -std=c++14 $(BOOST_FLAGS) $(SIMD_FLAGS)
	 emcc main_render.o -lopenvino -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -DCOMPUTE -o w3001.js \
