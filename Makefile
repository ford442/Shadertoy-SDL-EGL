...
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 -sGL_TRACK_ERRORS=1

LINK_FLAGS += $(LDFLAGS) -sABORT_ON_WASM_EXCEPTIONS=1 -sDEMANGLE_SUPPORT=0 -sWASMFS=0 -sASSERTIONS=0 \
	 --use-preload-plugins --closure 0 --closureFriendly -sHTML5_SUPPORT_DEFERRING_USER_SENSITIVE_REQUESTS=1 \
...
b3_shader_webgpu:
	 ...
	 -DLIB_WEBGPU_CPP20 $(COMMON_FLAGS) -O2 -o s3026.js $(LINK_SIMD_FLAGS) \
