...
LINK_FLAGS += $(LDFLAGS) -sOFFSCREENCANVAS_SUPPORT=1 -sTEXTDECODER=0 -sALLOW_TABLE_GROWTH=1 -sEMULATE_FUNCTION_POINTER_CASTS=1 -sSUPPORT_BIG_ENDIAN=1 \
...
b3_shader_webgpu:
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_str","_swp","_r4nd","_ud","_uu","_vd","_vu","_ml","_mr","_mu","_md","_setTempRet0"]' \
