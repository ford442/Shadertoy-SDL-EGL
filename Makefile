b3hd:
	 ...
	 -fuse-ld=mold -s USE_PTHREADS=1 -sPTHREAD_POOL_SIZE=2 -sENVIRONMENT=web,worker -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
