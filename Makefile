...
fire:
	 ...
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1536mb -sTOTAL_STACK=32mb \
	 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 \
	 -sUSE_SDL=2 -sFULL_ES3=1 \
	 -ffast-math -flto=thin -std=gnu++2b -stdlib=libc++ \
         -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3","_nano"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
         --post-js fluid.js --post-js flui.js --extern-pre-js setUp.js --extern-pre-js startUp.js --extern-pre-js cl-gpu.js --post-js pageg.js
