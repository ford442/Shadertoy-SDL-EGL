...
b3_vanilla_llvm:
	 ...
	 emcc src/vanilla/js.c -c -O0 -std=gnu17 -flto=thin -sUSE_BOOST_HEADERS=1 -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128
	 ...
	 -sEXPORTED_FUNCTIONS='["_js_hello","_js_tuple_float","_js_tuple_gl","_js_tuple_avx"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
