...
b3_shader_webgpu:
	 ...
	 em++ $(STDS) -c src/shader/shader_webgpu.cpp $(COMMON_FLAGS) $(THREAD_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS)
	 em++ $(STDS) -c src/shader/main.cpp $(COMMON_FLAGS) $(THREAD_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS)
	 em++ $(STDS) $(COMMON_FLAGS) $(LINK_FLAGS) $(THREAD_FLAGS) $(GL_FLAGS) \
...
b3_vanilla_render:
	 ...
	 emcc $(LD_FLAGS) -fPIC -fPIE -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -DCOMPUTE -o w3001.js \
...
b3_shader_glsl:
	 ...
	 ###         Link
	 @sh clang12.sh; \
	 emcc main.o shader_glsl.o -o gl001.js $(COMMON_FLAGS) -O2  $(LINK_SIMD_FLAGS) $(LD_FLAGS) $(BOOST_FLAGS) \
