b3hd:
	 ...
	 em++ src/b3emjs.cpp -c -O0 -nostdlib -march=wasm64-emscripten -sMEMORY64=2 \
	 -std=c++2a \
	 ...
	 em++ src/b3main.cpp -c -O3 -nostdlib -march=wasm64-emscripten -sMEMORY64=2 \
	 ...
	 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sASSERTIONS=0 -USE_GLFW=0 \
         -sEXPORTED_FUNCTIONS='["_main","_str","_b3","_b3_egl","_nano","_clr","_frm"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
