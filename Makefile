...
b3_glsl_render:
	 ...
	 -I /content/RAMDRIVE2/b3/include/vanilla/ -O0 -I /content/RAMDRIVE2/b3/tint/ -I /content/RAMDRIVE2/b3/SPIRV-Tools/include/ -I /content/RAMDRIVE2/b3/SPIRV-Cross/ -c $(BOOST_FLAGS) $(SIMD_FLAGS)
