...
b3_compute_egl_tex:
	 em++ src/vanilla/webgpu_egl_tex.cpp -O2 -fchar8_t -std=c++14 $(GL_FLAGS) \
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -I/content/RAMDRIVE2/aubio/src -c $(BOOST_FLAGS) $(SIMD_FLAGS)
	 em++ -O2 -dead_strip --js-library lib/lib_webgpu.js -fPIC -fPIE -DCOMPUTE -o $(WGL_BIN_NAME)-egl-tex.js \
