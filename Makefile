b3hd:
	 em++ -nostdlib -fno-math-errno -fPIC -fexperimental-library \
	 -std=c++2a -O0  \
	 ...
	 -ffp-exception-behavior=maytrap -ffast-math -ffp-contract=on -mllvm src/b3ogl.cpp -c 
	 ...
	 -ffp-exception-behavior=maytrap -fno-fast-math -ffp-contract=on -mllvm
