...
heap: h3.cpp  Makefile
	em++ h3.cpp -O1 -o g3006.js -sFORCE_FILESYSTEM=1 -sENVIRONMENT=web  \
	-sALLOW_MEMORY_GROWTH=1 -sINITIAL_MEMORY=3200mb \
	...
	-sUSE_SDL=2 -sFULL_ES3=1 -sFULL_ES2=0 \
	 ...
	 --closure 1 -g2 -std=gnu++2b -flto=thin -sMAXIMUM_MEMORY=4000mb \
