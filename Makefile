LDFLAGS += -Wl,-O3,--lto-O3,--stack-first,-lm,-lpthread
...
LINK_FLAGS += -fno-except $(LDFLAGS) -lpthread -sPTHREAD_POOL_SIZE=42 --use-preload-plugins --closure 0 --closureFriendly \
...
b3_vanilla_icc:
	 ...
	 emcc main_icc.o -O0 -o w3003.js -fPIC -fPIE -Wl,-lm,-lrt -ltbb \
