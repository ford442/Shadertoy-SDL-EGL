...
COMMON_FLAGS += -O0 -flto -std=gnu17 -std=gnu++20 -stdlib=libc++ -fno-fast-math -ffp-contract=on -fwasm-exceptions \
...
b3_vanilla_webgpu:
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_startWebGPU","_runWebGPU"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
