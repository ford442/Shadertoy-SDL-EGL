...
tst8: egl4.cpp  Makefile
	em++ egl4.cpp -sFULL_ES3=1 --closure 1 -g0 -sGL_TESTING=0 -sUSE_SDL=0 -sMODULARIZE=0 \
...
-DNDEBUG -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -ffast-math -O3 \
 ...
 --post-js filesysNoSDL.js --post-js ccall.js --post-js fs.js --extern-post-js startUp.js --extern-post-js setUp.js
