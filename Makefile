...
b3_combine_test:
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3","_b3_egl","_nano","_clr"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
	 --pre-js startUp.js --pre-js rSlider.js --pre-js slideOut.js --pre-js gpujs.js --extern-post-js fluid.js --extern-post-js flui.js
...
b3_vanilla_test:
	 ...
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -sNO_DISABLE_EXCEPTION_CATCHING -sPRECISE_F32=2 -sWASM_BIGINT=1 -fuse-ld=ld64 -mtune=corei7-avx \
