...
b3_vanilla_webgpu:
	 ...
	 em++ lib/lib_webgpu_cpp20.cpp lib/lib_webgpu.cpp -static -sUSE_BOOST_HEADERS=1 -std=gnu17 -std=gnu++20 -stdlib=libc++ -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
	 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2
