...
b3_combine_dev:
	 em++ src/combine/main.cpp -c -O0 -std=c++20 -stdlib=libc++ -flto -fpie \
	 ...
	 em++ src/combine/combine.cpp -c -O0 -std=c++20 -stdlib=libc++ -flto -fpie -fno-math-errno -mcpu=bleeding-edge -fstrict-vtable-pointers -fwhole-program-vtables \
	 -ffp-contract=on \
	 ...
	 emcc main.o audio.o combine.o -o b3hd002.js -static-pie -mllvm -O0 -std=c++20 -stdlib=libc++ -sUSE_SDL=2 -flto -sTOTAL_STACK=700MB \
...
b3_shader_llvm:
	 ...
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ftree-vectorize -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 emcc main.o shader.o -o s3021.js -flto=thin -mllvm -fwasm-exceptions -force-vector-width=4 -O0 -static-pie -std=c++20 -stdlib=libc++ -fno-math-errno \
