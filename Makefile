...
LINK_FLAGS +=  -fno-except $(LDFLAGS) -DISABLE_EXCEPTION_CATCHING=1 --use-preload-plugins --closure 0 --closureFriendly \
...
b3_vanilla_webgpu:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/vanilla/main_webgpu.cpp -I/usr/include/thrust -I/usr/include/thrust/detail  -O3 -c -std=c++17 $(BOOST_FLAGS) $(SIMD_FLAGS) -BOOST_NO_EXCEPTIONS
...
b3_shader_webgpu:
	 ...
	 $(GL_FLAGS) $(LINK_FLAGS) $(WEBGPU_FLAGS) $(BOOST_FLAGS) -DINTRINS -DGLH -sDEMANGLE_SUPPORT=0 \
	 -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=1024mb \
