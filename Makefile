...
SIMD_FLAGS += -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx -DSIMD=AVX -sUSE_SIMD=1
...
GL_FLAGS += -sFULL_ES3=1 -sUSE_GLFW=3 -Wl,-lGL,-lEGL,-lGLESv2 -sUSE_REGAL=1 \
