...
b3_vanilla_webgpu:
	 ...
	 -sASYNCIFY=1 -sASYNCIFY_IMPORTS=wgpu_buffer_map_sync,wgpu_adapter_request_device_sync,wgpu_adapter_request_device_sync -sTEXTDECODER=2 -sPRECISE_F32=1 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_GLFW=3 \
