...
b3_vanilla_webgpu:
	 ...
	 emcc main_webgpu.cpp.o js.o libwebgpu.a -o w3000.js -mllvm -std=gnu17 -std=gnu++20 -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
