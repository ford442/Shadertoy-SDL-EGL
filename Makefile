...
b3_vanilla_render:
	 emcc lib/lib_webgpu_cpp20.cpp lib/lib_webgpu.cpp -static -o libwebgpu.bc
	 emcc src/vanilla/main_render.cpp -std=c++20 \
	 -I/content/RAMDRIVE2/b3/include/vanilla/ -c $(BOOST_FLAGS) $(SIMD_FLAGS)
	 emcc $(LDFLAGS) --js-library lib/lib_webgpu.js -L./ -lwebgpu.bc -fPIC -fPIE -DCOMPUTE -o w3001.js \
