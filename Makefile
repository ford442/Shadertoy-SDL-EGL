...
b3_vanilla_webgpu:
	 ...
	 em++ lib/lib_webgpu_cpp20.cpp lib/lib_webgpu.cpp -o libwebgpu.so -std=gnu17 -std=gnu++20 -stdlib=libc++ \
	 emcc src/vanilla/js.c -c -std=gnu17 -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128
	 emcc main_webgpu.o js.o libwebgpu.so -o w3000.js -mllvm -std=gnu17 -std=gnu++20 -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
