...
b3_shader_speed:
	 ...
	 -Wno-implicit-function-declaration -fpic -O3 -fopenmp-simd -std=gnu++20 -stdlib=libc++ -flto=thin -fchar8_t -ffast-math -funsafe-math-optimizations -fno-math-errno \
	 ...
	 -Wno-implicit-function-declaration -fpic -O3 -fopenmp-simd -ffast-math -msimd128 -mbulk-memory -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx -fmerge-all-constants -fno-stack-protector \
	 ...
	 ###         Link
	 @sh clang12.sh; \
	 emcc main.o shader_speed.o -o s3024s.js -std=gnu++20 --use-preload-plugins \
	 -Wno-implicit-function-declaration -fpic -O3 -fopenmp-simd -mtail-call -mmultivalue -mnontrapping-fptoint -msign-ext \
	 -fborland-extensions -flto=thin -mllvm -ffast-math -ffp-contract=fast -mbulk-memory -fno-stack-protector \
	 ...
	 -Xclang -menable-no-nans -Xclang -menable-no-infs -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx -mpclmul -msha -mfma -mbmi2 -mpopcnt \
	  -Wl,--lto-O3 -Wl,--stack-first -mcx16 -mavxifma -mbmi -mbmi2 -mlzcnt -mavxneconvert -mavxvnni -fblocks -fstrict-vtable-pointers -funsafe-math-optimizations \
	 -sFETCH_SUPPORT_INDEXEDDB=0 -sALLOW_TABLE_GROWTH=1 -sGL_MAX_TEMP_BUFFER_SIZE=4096mb -sUSE_GLFW=0 \
	 -sDYNAMIC_EXECUTION=0 -sPRECISE_F32=1 -sUSE_BOOST_HEADERS=1 -sTOTAL_STACK=8MB -sUSE_WEBGPU=1 --closureFriendly \
	 -sGL_ASSERTIONS=0 -sWASM_BIGINT=1 -DWORDS_BIGENDIAN=0 -sSUPPORT_LONGJMP=0 -NDEBUG -BOOST_UBLAS_NDEBUG \
	 -sGLOBAL_BASE=8388608 -sPOLYFILL=0 -sFAST_UNROLLED_MEMCPY_AND_MEMSET=1 -sSTACK_OVERFLOW_CHECK=2 \
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_str","_swp","_r4nd","_ud","_uu","_vd","_vu","_ml","_mr","_mu","_md"]' -sEXPORTED_RUNTIME_METHODS='["ccall","FS"]' \
	 -sTEXTDECODER=1 --pre-js js/module.js --pre-js rSlider.js --pre-js slideOut.js
...
b3_audio:
	...
	-fpic -O3 -fopenmp-simd -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -fmerge-all-constants -mmultivalue \
	...
	-fuse-id=lld -fpic -O3 -fopenmp-simd -Xclang -menable-no-nans -Xclang -menable-no-infs -sPRECISE_F32=1 -sTEXTDECODER=1 -mcpu=bleeding-edge \
