b3hd:
	 ...
	 em++ src/b3sdl.cpp -c \
	 -sUSE_SDL=2 -std=c++2b -nostdlib -fslp-vectorize -ftree-vectorize \
	 ...
	 emcc b3main.o b3ogl.o b3sdl.o b3emjs.o -o g3020.js -O0 -nostdlib \
	 -sPRECISE_F32=1 -DNDEBUG -sWASM_BIGINT=1 -std=c++2b -mcpu=bleeding-edge -fwasm-exceptions \
