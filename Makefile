...
b3_vanilla_llvm:
	 em++ src/vanilla/main.cpp -c -lboost_random -sUSE_BOOST_HEADERS=1 -std=c++17 -stdlib=libc++ -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
	 ...
	 emcc main.o js.o -o v3020.js -lboost_random -mllvm -std=c++2b -mtail-call -mmultivalue -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
