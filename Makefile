b3_shader_llvm:
	 ...
	 -sGL_POOL_TEMP_BUFFERS=0 -sGL_MAX_TEMP_BUFFER_SIZE=768mb -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sENVIRONMENT=web -sPRECISE_I64_MATH=2 \
