...
COMMON_FLAGS += -sDISABLE_EXCEPTION_CATCHING=1 -flto=thin -mno-tail-call -O2 -m32 -fPIC -fmerge-all-constants -ffast-math -ffp-contract=off \
...
b3_vanilla_icc:
	 ...
	 ar rcs icc.a icc.o
	 emcc icc.a src/vanilla/main_icc.cpp -O0 -c -std=c++17 $(BOOST_FLAGS) $(SIMD_FLAGS) -BOOST_NO_EXCEPTIONS 
	 emcc main_icc.o icc.a -O0 -o w3003.js -fPIC \
	 ...
	 -sSUPPORT_ERRNO=0 \
	 -sPRECISE_F32=1 \
	 -sEXPORTED_FUNCTIONS='["_main","_icctest","_testicc","_js_simd","_js_tuple_float_short","_js_tuple_float_long","_js_tuple_gl","_js_tuple_avx","_js_tuple_avx_gl","_js_Tensors","_js_double","_js_noblock"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
