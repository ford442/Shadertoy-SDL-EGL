...
video_resurection_webgpua:
	 ...
	 emcc src/video/video_jebusa.cpp -I/content/RAMDRIVE2/b3/include/vanilla/ $(COMMON_FLAGS) -o video_jebusa.o -c $(STDS) $(BOOST_FLAGS) $(SIMD_FLAGS)
	 emcc video_jebusa.o $(COMMON_FLAGS) -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o $(BIN_NAME)-resA.js $(STDS) $(GL_FLAGS) $(BOOST_FLAGS) $(LINK_FLAGS) $(LINK_SIMD_FLAGS) \
