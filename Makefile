...
b3_vanilla_webgpu:
	 ...
	 /opt/intel/oneapi/compiler/2023.2.0/linux/bin/icpx src/icctest.cpp -o icctest.o
	 em++ src/vanilla/main_render.cpp -c -std=c++14 $(BOOST_FLAGS) $(SIMD_FLAGS)
	 emcc main_render.o icctest.o -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -DCOMPUTE -o w3001.js \
