b3hd:
	 ...
	 -sDYNAMIC_EXECUTION=0 -sINCLUDE_FULL_LIBRARY=1 -USE_GLFW=0 -sASSERTIONS=0 -sPRECISE_F32=1 -DNDEBUG -sWASM_BIGINT=1 -std=c++2a -mcpu=bleeding-edge -fwasm-exceptions \
