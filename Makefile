...
COMMON_FLAGS += -pipe -pthread -sDISABLE_EXCEPTION_CATCHING=1 -fPIC -fpie -finline-functions -funroll-loops -fno-rtti \
...
LINK_FLAGS += $(LDFLAGS) -sWASMFS=0 -sASSERTIONS=0 -fno-except -sUSE_PTHREADS=1 -sSHARED_MEMORY=0 -sWASM_WORKERS=1 -sPTHREAD_POOL_SIZE=64 --use-preload-plugins --closure 0 --closureFriendly \
