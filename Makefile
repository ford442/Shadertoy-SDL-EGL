...
b3_vanilla_webgpu:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/vanilla/main_webgpu.cpp -O3 -c $(STDS) $(BOOST_FLAGS) $(SIMD_FLAGS) -BOOST_NO_EXCEPTIONS
	 em++ main_webgpu.o -O3 -fPIC -fPIE -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -o w3001.js \
	 $(STDS) $(BOOST_FLAGS) $(LINK_SIMD_FLAGS) -s DYNAMIC_IMPORT_LIB=/usr/lib/x86_64-linux/lib/libOpenCL.so \
