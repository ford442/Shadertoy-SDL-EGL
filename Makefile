b3hd:
	 ...
	 -msimd128 -Dsimd=avx -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -mbulk-memory -msign-ext -ffast-math -ffp-contract=fast -freciprocal-math
	 emcc b3main.o b3sdl.o b3ogl.o b3emjs.o -o g3020.js -O0 -std=c++11 -fPIC -fexperimental-library -mllvm -polly -static -DNDEBUG -fno-math-errno -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 \
