...
b3_vanilla_llvm:
	 ...
	 -sEXPORTED_FUNCTIONS='["_main","_wgpu_init1","_wgpu_init2","_js_simd","_js_hello","_js_tuple_float_short","_js_tuple_float_long","_js_tuple_gl","_js_tuple_avx","_js_tuple_avx_gl","_js_Tensors","_js_double","_js_noblock"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
	 --pre-js rSlider.js --pre-js slideOut.js
