...
sdl: sdl.cpp  Makefile
	em++ sdl.cpp -std=gnu++2b --closure 1 -g0 -O2 -sUSE_SDL=2 -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1 \
-sUSE_WEBGL2=1 -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=2 -sFORCE_FILESYSTEM=1 \
...
--post-js filesys.js --pre-js ccall.js --post-js fs.js --extern-pre-js setUp.js
