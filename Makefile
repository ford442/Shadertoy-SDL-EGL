...
b3_vanilla_webgpu:
	 ...
	 em++ boost/compute.hpp $(STDS) -stdlib=libc++ -static
	 emcc main_webgpu.o -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -DCOMPUTE -o w3001.js \
...
b3_shader_webgpu:
	 ...
	 -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=2048mb -sPRECISE_F32=0 -sDISABLE_EXCEPTION_THROWING=0 -sWASM_BIGINT=0 \
