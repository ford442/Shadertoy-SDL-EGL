...
b3_audio_mk:
	...
	em++ $(STDS) -c src/audio/audio.cpp $(COMMON_FLAGS) -Wno-incompatible-function-pointer-types -O2 $(SIMD_FLAGS) $(BOOST_FLAGS) \
	-sUSE_SDL_MIXER=2 -sUSE_OGG=0 -sUSE_VORBIS=0 -sUSE_SDL_IMAGE=0 -sUSE_SDL_TTF=0 -sUSE_SDL_NET=0 
	em++ $(STDS) -o a3020.js $(COMMON_FLAGS) -O2 $(LINK_FLAGS) $(LINK_SIMD_FLAGS) $(BOOST_FLAGS) \
	-sUSE_SDL_MIXER=2 -sUSE_SDL_IMAGE=0 -sUSE_SDL_TTF=0 -sUSE_SDL_NET=0 -sUSE_OGG=0 -sUSE_VORBIS=0 \
