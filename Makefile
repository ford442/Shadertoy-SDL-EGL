tst1: main.cpp  Makefile
    ...
    -O3 -std=c++17 -o shader.js -sEXPORTED_FUNCTIONS='["_main","_pl","_chng"]' -sEXPORTED_RUNTIME_METHODS=ccall \
    --extern-post-js index.js --post-js filesys.js --post-js ccall.js
