...
b3_shader_webgpu:
	 ...
	 em++ -std=c++14 include/shader/boost_includes.hpp $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS) -c -o boost_includes.o -static
	 ...
	 $(GL_FLAGS) $(LINK_FLAGS) $(WEBGPU_FLAGS) $(BOOST_FLAGS) -DINTRINS -DGL -DBOOST_INCLUDES \
