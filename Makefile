...
GL_FLAGS += -sFULL_ES3=1 -sFULL_ES2=0 -lglfw3 -lglut -lSDL -lGL -lGLESv2 -lEGL -lX11 -sUSE_GLFW=3 -sUSE_REGAL=0 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
...
LINK_FLAGS += $(LDFLAGS) -sWASM_BIGINT=1 -sLEGALIZE_JS_FFI=0 -sMALLOC=emmalloc -sOFFSCREENCANVAS_SUPPORT=1 -sTEXTDECODER=0 -sALLOW_TABLE_GROWTH=1 -sEMULATE_FUNCTION_POINTER_CASTS=0 -sSUPPORT_BIG_ENDIAN=1 \
