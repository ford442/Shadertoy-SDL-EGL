...
-ftree-vectorize -fprofile-generate -fprofile-arcs \
...
b3_vanilla_webgpu:
	 ...
	 -mllvm -std=gnu17 -std=gnu++20 $(BOOST_FLAGS) $(LINK_SIMD_FLAGS) \
	 -jsDWEBGPU_DEBUG=1 -polly -sALLOW_MEMORY_GROWTH=0 \
...
b3_vanilla_llvm:
	 em++ src/vanilla/main.cpp -c -sUSE_BOOST_HEADERS=1 -std=gnu17 -std=gnu++17 -stdlib=libc++ -mmultivalue=false -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
	 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2
	 emcc src/vanilla/js.c -c -std=gnu17 -mmultivalue=false -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128
	 emcc main.o js.o -o v3020.js -mllvm -std=gnu17 -std=gnu++17 -mmultivalue=false -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 \
	 -polly -sALLOW_MEMORY_GROWTH=1 -sUSE_BOOST_HEADERS=1 -sUSE_WEBGPU=1 -sINITIAL_MEMORY=2048mb \
...
b3_shader_webgpu:
	 ...
	 -sUSE_SDL=0 -Wno-implicit-function-declaration -fmerge-all-constants -mmultivalue=false -fno-stack-protector \
	 ...
	 -mmultivalue=false -mnontrapping-fptoint -fno-stack-protector \
	 ...
	 -sUSE_SDL=0 --use-preload-plugins --closure 0 --closureFriendly -Wno-implicit-function-declaration -mmultivalue=false -mnontrapping-fptoint \
...
b3_video_google_llvm:
	 ...
	 -polly -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 \
...
b3_shader_speed:
	 ...
	 -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 \
...
b3_combine_dev:
	 ...
	 -sEVAL_CTORS=1 -polly -sFORCE_FILESYSTEM=1 --closure 0 --closureFriendly -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb -sDYNAMIC_EXECUTION=0 -sGL_UNSAFE_OPTS=0 \
...
b3_audio:
	...
	-O3 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -fmerge-all-constants -mmultivalue=false \
	...
	-polly -sUSE_GLFW=0 -DSIMD=AES -DEMMALLOC_USE_64BIT_OPS=1 \
...
b3_googleStreetView_dev:
	 ...
	 -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sUSE_GLFW=3 -DEMMALLOC_USE_64BIT_OPS=1 \
...
b3_shader_glsl:
	 ...
	 -Wno-implicit-function-declaration -fmerge-all-constants -mmultivalue=false \
	 -fblocks -mnontrapping-fptoint -Rpass=loop-vectorize -fasynchronous-unwind-tables \
	 -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 ###         Main
	 em++ src/shader/main.cpp -c $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS) \
	 -Wno-implicit-function-declaration -fmerge-all-constants \
	 -mmultivalue=false -mnontrapping-fptoint \
	 -fblocks -Rpass=loop-vectorize -fasynchronous-unwind-tables -Rpass-missed=loop-vectorize \
	 -Rpass-analysis=loop-vectorize
	 ###         Link
	 @sh clang12.sh; \
	 emcc main.o shader_glsl.o -o gl001.js $(COMMON_FLAGS) $(LINK_SIMD_FLAGS) $(LDFLAGS) $(BOOST_FLAGS) \
	 --use-preload-plugins --closureFriendly -Wno-implicit-function-declaration -mmultivalue=false -mnontrapping-fptoint \
	 ...
	 -sGLOBAL_BASE=8388608 -sASSERTIONS=2 -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 \
	 -sGL_UNSAFE_OPTS=1 -sGL_POOL_TEMP_BUFFERS=0 -sALLOW_TABLE_GROWTH=1 \
...
b3_video_shader_llvm:
	 ...
	 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ffp-contract=on -mcpu=bleeding-edge
	 em++ src/video/video_shader.cpp -c -std=gnu++2b -stdlib=libc++ -flto -fno-math-errno -O3 \
	 -mcpu=bleeding-edge -fwasm-exceptions -ffunction-sections -fdata-sections -ffp-contract=off \
	 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2
	 emcc main_shader.o video_shader.o -o sh001.js -mllvm -flto -std=gnu++2b -stdlib=libc++ -fno-math-errno -O3 \
	 -polly -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 \
	 -Xclang -menable-no-nans -Xclang -menable-no-infs -sTEXTDECODER=1 \
	 -msimd128 -mavx -mpclmul -maes -mavx2 -msha -mfma -mbmi2 -mpopcnt -mcx16 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -sPRECISE_F32=1 -sWASM_BIGINT=0 -mtune=tigerlake -march=corei7-avx -mavxifma \
...
b3_shader_llvm:
	 ...
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -flto -fstrict-vtable-pointers -mtail-call -mmultivalue=false -mnontrapping-fptoint -msign-ext \
	 ...
	 -sDYNAMIC_EXECUTION=0 -sPRECISE_F32=0 -sWASM_BIGINT=0 -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -lc++abi -mtail-call -mmultivalue=false -mnontrapping-fptoint -msign-ext \
	 -sASSERTIONS=0 -s DYLINK_DEBUG=0 -polly -sFORCE_FILESYSTEM=1 -wasm-enable-eh -exception-model=wasm -sPOLYFILL=0 -sFAST_UNROLLED_MEMCPY_AND_MEMSET=1 -sUSE_GLFW=0 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb -sGL_UNSAFE_OPTS=0 \
...
b3hd:
	...
	-mmultivalue=false -mextended-const -fno-signed-zeros -freciprocal-math -ffp-contract=off \
	-Xclang -menable-no-nans -Xclang -menable-no-infs \
	...
	-mmultivalue=false -mextended-const -fno-signed-zeros -freciprocal-math -ffp-contract=off -Xclang -menable-no-nans -Xclang -menable-no-infs \
	...
	-DSIMD=AES -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
...
b3_combine_test:
	 em++ src/combine/main.cpp -c -O0 -std=c++20 -stdlib=libc++ \
	 ...
	 -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
...
b3_combine_llvm:
	 em++ src/combine/main.cpp -c -O0 -std=gnu++2b -stdlib=libc++ \
	 -ffast-math -fno-math-errno -mcpu=bleeding-edge \
	 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -ffp-contract=off -fwasm-exceptions -ffunction-sections -fdata-sections
	 em++ src/combine/audio.cpp -c -O0 -std=gnu++2b -stdlib=libc++ -sUSE_SDL=2 -fno-fast-math \
	 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -ffp-contract=on -fno-math-errno -mcpu=bleeding-edge -fwasm-exceptions -ffunction-sections -fdata-sections
	 em++ src/combine/video.cpp -c -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno -mcpu=bleeding-edge \
	 ...
	 em++ src/combine/shader.cpp -c -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno -mcpu=bleeding-edge \
	 -fno-fast-math -ffp-contract=on \
	 -msimd128 -mavx -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -fwasm-exceptions -ffunction-sections -fdata-sections
	 emcc main.o audio.o video.o shader.o -o b3hd002.js -static-pie -mllvm -O0 -std=gnu++2b -stdlib=libc++ -sUSE_SDL=2 -flto -sTOTAL_STACK=128MB \
...
b3_shader_test:
	 ...
	 emcc main.o shader.o -o s3021.js -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno -ffp-contract=fast \
	 ...
	 -polly -sWASMFS=0 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
	 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_UNSAFE_OPTS=0 \
...
b3_shader_js:
	 ...
	 -ffunction-sections -fdata-sections -ffp-contract=on
	 em++ src/shader/shader.cpp -c -O0 -fno-math-errno -std=gnu++2b -fno-fast-math -ffp-contract=off \
	 -fno-math-errno -std=c++2b -stdlib=libc++ -mcpu=bleeding-edge -msimd128 -mavx \
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
	 -ffunction-sections -fdata-sections
	 emcc main.o shader.o -o s3021js.js -O0 -sWASM=0 -std=gnu++2b -stdlib=libc++ -fno-math-errno -ffp-contract=off \
	 -mcpu=bleeding-edge -ffunction-sections -fdata-sections \
	 -Xclang -menable-no-nans -Xclang -menable-no-infs -msimd128 -mavx -mpclmul -maes -mavx2 -msha \
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -sFETCH_SUPPORT_INDEXEDDB=0 \
...
b3_video_test:
	 ...
	 -mcpu=bleeding-edge -ffunction-sections -fdata-sections \
	 -polly -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -sUSE_GLFW=0 \
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb -sFETCH_SUPPORT_INDEXEDDB=0 \
	 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_UNSAFE_OPTS=0 \
	 -sEXPORTED_FUNCTIONS='["_main","_b3","_b3_egl","_nano","_r4nd"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
	 --extern-pre-js gpujsx.js --pre-js rSlider.js --pre-js slideOut.js
...
b3_video_llvm:
	 ...
	 -mcpu=bleeding-edge -ffunction-sections -fdata-sections \
	 -polly -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -sUSE_GLFW=1 \
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb -sFETCH_SUPPORT_INDEXEDDB=0 \
	 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_UNSAFE_OPTS=0 \
	 -sEXPORTED_FUNCTIONS='["_main","_b3","_b3_egl","_nano","_r4nd"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
...
b3_video_web_llvm:
	 ...
	 -polly -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -sUSE_GLFW=3 \
	 -Xclang -menable-no-nans -Xclang -menable-no-infs -sTEXTDECODER=1 \
	 -msimd128 -mavx -mpclmul -maes -mavx2 -msha -mfma -mbmi2 -mpopcnt -mcx16 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 \
...
b3_vanilla_simd:
	 ...
	 -polly -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
...
speed:
	 ...
	 -mmultivalue=false -mextended-const -fno-signed-zeros -freciprocal-math -ffp-contract=fast -Xclang -menable-no-nans -Xclang -menable-no-infs \
	 -sFULL_ES2=0 -sFULL_ES3=1 -sPRECISE_F32=2 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 \
