b3_shader_llvm:
	 ...
	 -mcpu=bleeding-edge -mtune=tigerlake -march=corei7-avx -ffunction-sections -fdata-sections -rtlib=compiler-rt -sTOTAL_STACK=256MB -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize \
	 ...
	 -sASSERTIONS=0 -s DYLINK_DEBUG=0 -fwhole-program -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sGLOBAL_BASE=0 -sGL_UNSAFE_OPTS=0 \
...
b3_combine_dev:
	 ...
	 emcc main.o audio.o combine.o -o b3hd002.js -sALLOW_TABLE_GROWTH=1 -ffp-contract=fast -fno-stack-protector -mllvm -O3 -mbulk-memory -fmerge-all-constants -std=c++20 -stdlib=libc++ -sUSE_SDL=2 -flto -sTOTAL_STACK=256MB \
	 ...
	 -fwhole-program -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sDYNAMIC_EXECUTION=0 -sGLOBAL_BASE=0 -sGL_UNSAFE_OPTS=0 \
