...
GL_FLAGS += -sFULL_ES2=1 -sUSE_SDL=0 -sLEGACY_GL_EMULATION=0 -lGL -lGLESv2 -lEGL -sUSE_GLFW=0 -sUSE_REGAL=1 \
...
video_test2:
	 ...
	 --extern-post-js js/pagec.js --extern-pre-js js/rSlider.js --extern-pre-js js/slideOut.js --pre-js js/gpujsx.js video_test.o
