...
COMMON_FLAGS += -sSUPPORT_LONGJMP=emscripten -sDEFAULT_TO_CXX=0 -pthread -pipe -mextended-const -mbulk-memory -matomics \
	 -sUSE_ICU=1 -sWASM_WORKERS=1 -sSHARED_MEMORY=1 \
...
GL_FLAGS += -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_GLFW=2 -Wl,-lGL,-lGLU,-lEGL,-lGLESv2 -sUSE_REGAL=1 \
...
LINK_FLAGS += $(LDFLAGS) -sALLOW_TABLE_GROWTH=1 -sEMULATE_FUNCTION_POINTER_CASTS=0 -sSUPPORT_BIG_ENDIAN=1 \
	 -sLZ4=1 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=0 -sIGNORE_MISSING_MAIN=0 -sABORT_ON_WASM_EXCEPTIONS=0 \
...
b3_vanilla_webgpu:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ -O0 -c -std=c++17 $(BOOST_FLAGS) $(SIMD_FLAGS) -I/content/RAMDRIVE2/b3/pytorch/aten/src/ \
	 -I/content/RAMDRIVE2/b3/pytorch/ -I/content/RAMDRIVE2/b3/pytorch/c10/mobil/ -I/content/RAMDRIVE2/b3/pytorch/c10/util/ src/vanilla/main_webgpu.cpp 
...
b3_shader_webgpu:
	 ...
	 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_TRACK_ERRORS=1 -sGL_MAX_TEMP_BUFFER_SIZE=1073741824\
	 main.o shader_webgpu.o -DINTRINS $(BOOST_FLAGS) -DLIB_WEBGPU \
	 ...
	 --js-library lib/lib_demo.js --js-library lib/library_miniprintf.js --js-library lib/lib_webgpu.js \
	 --closure-args=--externs=lib/webgpu-closure-externs.js \
	 --extern-pre-js gpujsx.js --extern-post-js rSlider.js --extern-post-js slideOut.js
