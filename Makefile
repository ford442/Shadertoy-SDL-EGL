b3_shader_llvm:
	 em++ src/shader/main.cpp -c -O0 -mfpmath='both' -menable-experimental-extensions -mabi=iwmmxt -inline-asm='intel' -ffast-math -msimd128 -mbulk-memory -mavx -fmerge-all-constants -fomit-frame-pointer \
	 ...
	 em++ src/shader/shader.cpp -c -O0 -mfpmath='both' -menable-experimental-extensions -mabi=iwmmxt -inline-asm='intel' -fno-math-errno -mbulk-memory -fomit-frame-pointer -ffp-contract=fast -fmerge-all-constants -ftls-model=local-exec \
	 ...
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ftree-vectorize -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 emcc main.o shader.o -o s3021.js -emit-llvm -mllvm -mfpmath='both' -menable-experimental-extensions -mabi=iwmmxt -inline-asm='intel' -mbulk-memory -fomit-frame-pointer -fmerge-all-constants -ftls-model=local-exec -fwasm-exceptions -force-vector-width=4 -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno \
