...
COMMON_FLAGS += -mno-tail-call -sDISABLE_EXCEPTION_CATCHING=1 -wasm-enable-eh -Og -fmerge-all-constants -ffast-math -ffp-contract=off \
...
GL_FLAGS += -sFULL_ES3=1 -sFULL_ES2=1 -sGL_MAX_TEMP_BUFFER_SIZE=128mb -sUSE_GLFW=3 \
