b3_shader_llvm:
	 ...
	 em++ src/shader/main.cpp -c -O0 -m32 -ffast-math -msimd128 -mbulk-memory -mavx -fmerge-all-constants -fno-stack-protector -ftls-model=local-exec \
	 ...
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ftree-vectorize -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 emcc main.o shader.o -o s3021.js -m32 -static -flto=thin -mllvm -ffp-contract=fast -ftree-vectorize -mbulk-memory -fno-stack-protector -fmerge-all-constants -ftls-model=local-exec -fwasm-exceptions -force-vector-width=4 -O0 -std=gnu++2b -stdlib=libc++ -fno-math-errno \
	 -mcpu=bleeding-edge -mtune=tigerlake -march=corei7-avx -ffunction-sections -fdata-sections -rtlib=compiler-rt -sTOTAL_STACK=128MB -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize \
	 ...
	 -sPRECISE_F32=1 -sWASM_BIGINT -DWORDS_BIGENDIAN=0 -DCPU_IS_LITTLE_ENDIAN=1 -lc -lc++ -lc++abi -mtail-call -mmultivalue -mnontrapping-fptoint -msign-ext \
	 -s ASSERTIONS=0 -s DYLINK_DEBUG=0 -s ALLOW_TABLE_GROWTH=1 -fwhole-program -polly -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=256mb \
...
b3_combine_dev:
	 ...
	 em++ src/combine/combine.cpp -c -O0 -std=c++20 -stdlib=libc++ -flto -fmerge-all-constants -mbulk-memory -fno-math-errno -mcpu=bleeding-edge -fstrict-vtable-pointers -fwhole-program-vtables \
	 -ffp-contract=fast \
	 ...
	 em++ src/combine/audio.cpp -c -O0 -std=c++20 -stdlib=libc++ -fmerge-all-constants -mbulk-memory -sUSE_SDL=2 -flto -fno-fast-math \
	 ...
	 emcc main.o audio.o combine.o -o b3hd002.js -ffp-contract=fast -mllvm -O0 -mbulk-memory -fmerge-all-constants -std=c++20 -stdlib=libc++ -sUSE_SDL=2 -flto -sTOTAL_STACK=512MB \
