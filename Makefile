b3hd:
	 ...
	 -sSIMD=1 -fapprox-func -mbulk-memory -msign-ext -mmutable-globals -mnontrapping-fptoint \
	 ...
	 -sSIMD=1 -fapprox-func -mbulk-memory -msign-ext -msimd128 -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -DSIMD=128 \
	 ...
	 -sSIMD=1 -DSIMD=128 -fuse-ld=mold -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
