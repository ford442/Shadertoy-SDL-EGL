b3hd:
	 em++ src/b3main.cpp -c \
         -std=gnu++11 -stdlib=libc++ -mcpu=bleeding-edge -fwasm-exceptions -ftree-vectorize \
	 ...
	 em++ src/b3sdl.cpp -c \
	 -sUSE_SDL=2 -std=gnu++11 -stdlib=libc++  -fslp-vectorize -ftree-vectorize \
	 ...
	 -mrelaxed-simd -sWASM_BIGINT=1 -std=c++11 -stdlib=libc++ -mcpu=bleeding-edge -fwasm-exceptions \
