...
GL_FLAGS += -sFULL_ES3=1 -sUSE_SDL=0 -sLEGACY_GL_EMULATION=0 -lGL -lGLESv2 -lEGL -sUSE_GLFW=0 -sUSE_REGAL=0 \
...
LINK_FLAGS += --target=wasm32 -sMALLOC=emmalloc $(LDFLAGS) -sDEFAULT_TO_CXX=0 -sLEGALIZE_JS_FFI=0 -sOFFSCREENCANVAS_SUPPORT=0 \
...
b3_shader_webgpu:
	 ...
	 em++ $(STDS) -o $(BIN_NAME) -O2 $(COMMON_FLAGS) \
