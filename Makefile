...
GL_FLAGS += -sFULL_ES3=1 -sUSE_GLFW=2 -Wl,-lGL,-lEGL,-lGLESv2 -sUSE_REGAL=1 \
...
b3_shader_webgpu:
	 ...
	 $(WEBGPU_FLAGS) -sDEMANGLE_SUPPORT=0 -jsDWEBGPU_NO_BW_COMPAT=1 -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=2536mb \
