...
b3_shader:
	em++ src/shader/shader.cpp -c -O0 -std=c++2a -stdlib=libc++
	em++ src/shader/main.cpp -c -O0 -std=c++11 -stdlib=libc++
	emcc shader.o main.o -o s3020.js -O0 -std=c++2a -stdlib=libc++ \
