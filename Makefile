...
GL_FLAGS += -sFULL_ES3=1 -lglfw3 -lglut -lSDL -lGL -lGLESv2 -lEGL -lX11 -sUSE_GLFW=0 -sUSE_REGAL=0 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
