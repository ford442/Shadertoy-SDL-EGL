b3_shader_llvm:
	 ...
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -emit-llvm -fstrict-vtable-pointers -fwhole-program-vtables \
	 ...
	 -fno-math-errno -std=c++20 -stdlib=libc++ -mcpu=bleeding-edge -msimd128 -mavx -emit-llvm -fstrict-vtable-pointers -fwhole-program-vtables \
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -fblocks \
	 -fwasm-exceptions -ffunction-sections -fdata-sections -ftree-vectorize -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
	 emcc main.o shader.o -o s3021.js -emit-llvm -mllvm -mbulk-memory -fmerge-all-constants -fwasm-exceptions -force-vector-width=4 -O0 -std=c++20 -stdlib=libc++ -fno-math-errno \
	 -mcpu=bleeding-edge -mtune=tigerlake -march=corei7-avx -ffunction-sections -fdata-sections -sTOTAL_STACK=1024MB -fvectorize -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize \
	 -Xclang -menable-no-nans -Xclang -menable-no-infs -msimd128 -mavx -mpclmul -maes -mavx2 -msha -mfma -mbmi2 -mpopcnt -mcx16 -mavxifma \
	 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -sFETCH_SUPPORT_INDEXEDDB=0 -fblocks -emit-llvm -fstrict-vtable-pointers -fwhole-program-vtables \
