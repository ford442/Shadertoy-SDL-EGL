...
b3_compute_egl_tex:
	 em++ src/vanilla/webgpu_egl_tex.cpp -mextended-const -mbulk-memory -matomics -pthread -O1 -fchar8_t -std=c++14 $(GL_FLAGS) \
	 ...
	 $(BOOST_FLAGS) $(LINK_SIMD_FLAGS) $(GL_FLAGS) -sASSERTIONS=1 \
