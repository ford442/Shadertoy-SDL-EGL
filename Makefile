...
LINK_FLAGS += $(LDFLAGS) -sWASM_BIGINT=1 -sLEGALIZE_JS_FFI=1 -sMALLOC=emmalloc -sOFFSCREENCANVAS_SUPPORT=1 -sTEXTDECODER=0 -sALLOW_TABLE_GROWTH=1 -sEMULATE_FUNCTION_POINTER_CASTS=0 -sSUPPORT_BIG_ENDIAN=1 \
