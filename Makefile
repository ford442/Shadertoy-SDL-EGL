...
LINK_FLAGS += $(LDFLAGS) -sWASMFS=0 -sASSERTIONS=0 -fno-except -sUSE_PTHREADS=1 -sSHARED_MEMORY=1 -sWASM_WORKERS=1 -sPTHREAD_POOL_SIZE=64 --use-preload-plugins --closure 0 --closureFriendly \
