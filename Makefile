...
tst2: main4.cpp  Makefile
	em++ main4.cpp -sFULL_ES3=1 --closure 0 -sGL_TESTING=0 -sUSE_SDL=2 -sEXPORT_NAME='createModule' -sMODULARIZE=1 \
...
--extern-post-js index.js --post-js filesys.js --extern-post-js fs.js --post-js ccall.js -sSUPPORT_BIG_ENDIAN=1
