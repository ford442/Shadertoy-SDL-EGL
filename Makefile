...
GL_FLAGS += -sFULL_ES3=1 -lglfw -lglut -lSDL -lGL -lGLESv2 -lEGL -lX11 -sRELOCATABLE=1 -sUSE_GLFW=3 -sUSE_REGAL=0 -sUSE_SDL=2 -sGL_SUPPORT_AUTOMATIC_ENABLE_EXTENSIONS=0 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
