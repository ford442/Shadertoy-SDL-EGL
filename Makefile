...
GL_FLAGS += -sFULL_ES3=1 -sUSE_GLFW=0 -Wl,-lGL,-lGLU,-lEGL,-lGLESv2 -sUSE_REGAL=1 -sGL_UNSAFE_OPTS=1 \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 -sGL_TRACK_ERRORS=0 \
-sLEGACY_GL_EMULATION=1 -sGL_TRACK_ERRORS=0 

LINK_FLAGS += $(LDFLAGS) -sGL_EMULATE_GLES_VERSION_STRING_FORMAT=0 -sABORT_ON_WASM_EXCEPTIONS=1 -sDEMANGLE_SUPPORT=0 -sWASMFS=0 -sASSERTIONS=0 -fno-except --use-preload-plugins --closure 0 --closureFriendly \
...
b3_shader_webgpu:
	 ...
	 $(WEBGPU_FLAGS) -sHTML5_SUPPORT_DEFERRING_USER_SENSITIVE_REQUESTS=0 -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=256mb \
