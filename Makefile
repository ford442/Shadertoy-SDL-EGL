...
COMMON_FLAGS += -O3 -fmerge-all-constants -ffast-math -ffp-contract=off -mnontrapping-fptoint -fno-stack-protector \
...
b3_vanilla_webgpu:
	 ...
	 /opt/intel/oneapi/compiler/2023.2.0/linux/bin/icpx -Wno-null-character -o icc.ispc src/vanilla/icc.cpp
	 /content/RAMDRIVE2/ispc-v1.20.0-linux/bin/ispc --target=avx1-i32x16 -o icc.o icc.ispc
	 emcc src/vanilla/main_render.cpp -c -std=c++14 $(BOOST_FLAGS) $(SIMD_FLAGS)
	 emcc main_render.o icc.ispc -DLIB_WEBGPU -DLIB_WEBGPU_CPP20 -DCOMPUTE -o w3001.js \
