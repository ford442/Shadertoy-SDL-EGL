...
COMMON_FLAGS += -sSHARED_MEMORY=1 -sDISABLE_EXCEPTION_CATCHING=1 -Og -fmerge-all-constants -ffast-math -ffp-contract=off -fno-stack-protector \
...
LINK_FLAGS += $(LDFLAGS) -sWASMFS=1 -DISABLE_EXCEPTION_CATCHING=1 --use-preload-plugins --closure 0 --closureFriendly -mllvm -mtune=haswell \
