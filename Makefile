...
b3_vanilla_webgpu:
	 ...
	 em++ src/vanilla/main_render.cpp -c -std=c++11 -stdlib=libc++  $(BOOST_FLAGS) $(SIMD_FLAGS)
...
b3_shader_webgpu:
	 ...
	 em++ -std=c++11 -c src/shader/shader_webgpu.cpp $(COMMON_FLAGS) $(SIMD_FLAGS) $(BOOST_FLAGS) -DDOUBLE
