...
GL_FLAGS := -sFULL_ES2=1 -sFULL_ES3=1 -sUSE_GLFW=0 -sUSE_REGAL=0 \
...
video_test:
	 ...
	 em++ $(STDS) -o b3671test.js $(COMMON_FLAGS) -O2 $(LINK_SIMD_FLAGS) \
	 ...
	 --extern-pre-js js/setUp.js  --pre-js js/startUp.js \
