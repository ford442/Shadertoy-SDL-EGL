...
fire:
	 em++ h3srgb.cpp -o g3011.js -sFORCE_FILESYSTEM=1 \
	 -sMAXIMUM_MEMORY=4096mb -sALLOW_MEMORY_GROWTH=1 -sINITIAL_MEMORY=1536mb \
	 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 \
	 -sUSE_SDL=2 -sFULL_ES2=0 -sFULL_ES3=1 \
	 -std=gnu++20 \
         -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3","_nano","_szz"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
         --extern-post-js fluid.js --extern-post-js flui.js --extern-post-js setUp.js --extern-post-js startUp.js --extern-post-js pageg.js --extern-post-js cl-gpu.js
