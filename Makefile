...
b3_shader_speed:
	 ###         Shader
	 @sh sudo update-alternatives --install /usr/bin/clang++ clang++ /usr/bin/clang++-6.0 100; \
	 @sh sudo update-alternatives --install /usr/bin/clang clang /usr/bin/clang-6.0 100; \
	 ...
	 -fPIC -O0 -ffast-math -msimd128 -mbulk-memory -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx -fmerge-all-constants -fno-stack-protector \
	 ...
	 ###         Link
	 @sh sudo update-alternatives --install /usr/bin/clang++ clang++ /usr/bin/clang++-12 100; \
	 @sh sudo update-alternatives --install /usr/bin/clang clang /usr/bin/clang-12 100; \
