LDFLAGS += -Wl,-lopenmp,-O3,--lto-O3,-lc++,-lc++abi,-lm,-lpthread,-lrt,-ldl,-S
...
GL_FLAGS += -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_GLFW=0 -sUSE_REGAL=0 -sUSE_SDL=2 -sGL_SUPPORT_SIMPLE_ENABLE_EXTENSIONS=0 \
