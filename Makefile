...
GL_FLAGS += -sFULL_ES3=1 -sUSE_GLFW=0 -Wl,-lGL,-lGLU,-lEGL,-lGLESv2 -sGL_SUPPORT_EXPLICIT_SWAP_CONTROL=0 \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 \
-sHTML5_SUPPORT_DEFERRING_USER_SENSITIVE_REQUESTS=1 -sGL_TRACK_ERRORS=1
