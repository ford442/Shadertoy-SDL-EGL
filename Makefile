...
COMMON_FLAGS += -O3 -stdlib=libc++ -fmerge-all-constants -ffast-math -ffp-contract=off -mnontrapping-fptoint -fno-stack-protector \
...
b3_shader_webgpu:
	 ...
	 em++ $(STDS) include/shader/gl.h $(COMMON_FLAGS) $(SIMD_FLAGS) -o intrins.o -static
	 em++ $(STDS) include/shader/egl.h $(COMMON_FLAGS) $(SIMD_FLAGS) -o intrins.o -static
	 ...
	 $(GL_FLAGS) $(LINK_FLAGS) $(WEBGPU_FLAGS) $(BOOST_FLAGS) -DINTRINS -DGL -DEGL \
	 -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=2048mb -sPRECISE_F32=1 -sDISABLE_EXCEPTION_THROWING=0 -sWASM_BIGINT=0 \
