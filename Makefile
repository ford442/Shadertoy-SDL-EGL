...
tst8: egl4.cpp  Makefile
	em++ egl4.cpp -std=c++20 -sFULL_ES3=1 --closure 0 -sGL_TESTING=1 \
...
--extern-post-js filesysNoSDL.js --extern-post-js ccall.js --post-js fs.js --extern-pre-js setUp.js --extern-post-js startUp.js
