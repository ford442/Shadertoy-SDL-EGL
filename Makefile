...
b3_vanilla_webgpu:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ -O0 -c -std=c++17 $(BOOST_FLAGS) $(SIMD_FLAGS)  -I/content/RAMDRIVE2/b3/pytorch/aten/src/ -I/content/RAMDRIVE2/b3/pytorch/c10/macros/ -I/content/RAMDRIVE2/b3/pytorch/c10/util/ src/vanilla/main_webgpu.cpp 
