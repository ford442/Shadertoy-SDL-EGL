...
b3_shader:
	 em++ src/shader/main.cpp -c -std=c++11 -stdlib=libc++
	 em++ src/shader/shader.cpp -c -std=c++2b -stdlib=libc++ -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx
	 emcc main.o shader.o -o s3020.js -std=c++2b -stdlib=libc++ -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx \
...
b3_video:
	 em++ src/video/main.cpp -c -std=gnu++2b -stdlib=libc++
	 em++ src/video/video.cpp -c -std=gnu++2b -stdlib=libc++
	 emcc main.o video.o -o b3020.js -std=gnu++2b -stdlib=libc++ -sASYNCIFY -sPRECISE_F32=2 \
