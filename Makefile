b3hd:
	 ...
	 em++ src/b3sdl.cpp -c \
	 -sUSE_SDL=2 -s USE_PTHREADS=1 -s PTHREAD_POOL_SIZE=2 -s PTHREAD_HINT_NUM_CORES=2 -std=c++2a -stdlib=libc++ -matomics -fslp-vectorize \
	 ...
	 -fuse-ld=mold -s USE_PTHREADS=1 -s PTHREAD_POOL_SIZE=2 -s PTHREAD_HINT_NUM_CORES=2 -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
