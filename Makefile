...
b3_onnx:
	 ...
	 em++ -D__EMSCRIPTEN__ main_onnx.o libonnxruntime_webassembly.a -g -O2 -std=c++20 -fchar8_t --js-library lib/lib_webgpu.js -fPIC -fPIE -DCOMPUTE -o $(WGL_BIN_NAME)-onnx.js \
