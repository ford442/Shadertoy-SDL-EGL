...
tst2: main4.cpp  Makefile
	emcc main4.cpp -sFULL_ES2=0 -sFULL_ES3=0 --closure 1 -g0 -g -sGL_TESTING=0 -sUSE_SDL=2 -sEXPORT_NAME='createModule' -sMODULARIZE=1 \
...
-O3 -o egl3.js -sEXPORTED_FUNCTIONS='["_main","_pl","_str"]' -sEXPORTED_RUNTIME_METHODS=ccall \
