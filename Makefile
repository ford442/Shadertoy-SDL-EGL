...
b3_compute_egl_tex4:
	 em++ src/vanilla/webgpu_tex3.cpp -pipe -ffp-contract=on -fexcess-precision=standard \
	 ...
	 -ffast-math -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -ffp-contract=on -sENVIRONMENT=web,node \
