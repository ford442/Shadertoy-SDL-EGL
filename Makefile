...
COMMON_FLAGS += -fno-except -flto=thin -mno-tail-call -sDISABLE_EXCEPTION_CATCHING=1 -Og -fmerge-all-constants -ffast-math -ffp-contract=off \
...
b3_vanilla_webgpu:
	 em++ lib/lib_webgpu_cpp20.cpp $(STDS) -static
	 em++ lib/lib_webgpu.cpp $(STDS) -static
	 em++ src/vanilla/main_webgpu.cpp -O3 -c -std=c++17  -I/usr/include/thrust $(BOOST_FLAGS) $(SIMD_FLAGS) -BOOST_NO_EXCEPTIONS
