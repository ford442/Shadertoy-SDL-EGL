...
b3_vanilla_webgpu:
	 ...
	 -mllvm -std=gnu17 -std=gnu++20 $(BOOST_FLAGS) \
	 ...
	 -sTEXTDECODER=2 -sPRECISE_F32=1 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_GLFW=3 \
...
b3_shader_webgpu:
	 ...
	 -sDYNAMIC_EXECUTION=0 -sPRECISE_F32=1 -sUSE_BOOST_HEADERS=1 -sTOTAL_STACK=16MB \
	 -sGL_ASSERTIONS=0 -sWASM_BIGINT=1 -DWORDS_BIGENDIAN=0 -BOOST_UBLAS_NDEBUG \
	 -sPOLYFILL=0 -sFAST_UNROLLED_MEMCPY_AND_MEMSET=1 \
	 -sSUPPORT_ERRNO=0 -sINITIAL_MEMORY=1024mb -lmath.js -lhtml5.js -lint53.js -sMALLOC=emmalloc -DEMMALLOC_USE_64BIT_OPS=1 \
	 ...
	 -jsDWEBGPU_DEBUG=0 -DNDEBUG -sEVAL_CTORS=1 -sFULL_ES2=1 -sFULL_ES3=1 -sUSE_GLFW=3 -sTEXTDECODER=2 -sWASM=1 \
