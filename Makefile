...
tst2: main4.cpp  Makefile
	emcc main4.cpp -g -sFULL_ES2=0 -sFULL_ES3=0 --closure 0 -sGL_TESTING=0 -sUSE_SDL=2 -sEXPORT_NAME='createModule' -sMODULARIZE=1 \
...
-O3 -o egl6.js -sEXPORTED_FUNCTIONS='["_main","_pl","_str"]' -sEXPORTED_RUNTIME_METHODS=ccall \
--extern-post-js index.js --extern-post-js filesys.js --extern-post-js ccall.js --extern-post-js fs.js --extern-post-js shader-web-background.min.js -sSUPPORT_BIG_ENDIAN=1
