...
b3_apng:
	 ...
	 -lpng16 -fPIC -m32 -flto -flto=thin -pipe -ffp-contract=fast -fexcess-precision=fast \
	 -ffast-math -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -fno-math-errno \
	 -mmutable-globals -mbulk-memory -matomics -mnontrapping-fptoint -msign-ext -fno-omit-frame-pointer \
	 -mextended-const -O2 -fno-strict-aliasing $(SIMD_FLAGS) -c -fno-rounding-math -fcx-limited-range -fassociative-math -freciprocal-math -fno-signed-zeros
	 em++ -g -O2 -I/content/RAMDRIVE2/libpng-1.6.43/ -L/content/RAMDRIVE2/libpng-1.6.43/.libs \
	 -lpng16 -fPIE -sEVAL_CTORS=0 -sEXIT_RUNTIME=0 -m32 -sMALLOC=mimalloc -sWASMFS=1 -sLEGALIZE_JS_FFI=1 \
	 ...
	 -sTRUSTED_TYPES=1 -sALLOW_UNIMPLEMENTED_SYSCALLS=1 -sIGNORE_MISSING_MAIN=0 \
	 -sASYNCIFY=1 -sUSE_LIBPNG=1 -sEXPORTED_FUNCTIONS='["_main","_runApng"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
...
b3_compute_mod_test2:
	 em++ src/vanilla/webgpu_mod.cpp $(STDS) -fPIC -pipe -ffast-math -ffp-contract=fast \
	 -fexcess-precision=fast \
	 -ffinite-math-only -funsafe-math-optimizations -fno-trapping-math -fno-math-errno \
	 -mmutable-globals -mbulk-memory -matomics -mnontrapping-fptoint -msign-ext -fno-omit-frame-pointer \
	 -mextended-const -O1 $(STDS) $(xGL_FLAGS) -fno-strict-aliasing \
	 ...
	 em++ $(mLDFLAGS) -fPIE -O1 -sLEGALIZE_JS_FFI=1 -sEVAL_CTORS=2 \
