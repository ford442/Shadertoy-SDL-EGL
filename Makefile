...
b3_vanilla_llvm:
	 ...
	 -mbulk-memory -mnontrapping-fptoint -msign-ext -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 \
	 -msse4.2
	 emcc src/vanilla/js.c -c -O0 -std=gnu17 -flto=thin -mtail-call -mmultivalue -mbulk-memory \
	 -mnontrapping-fptoint -msign-ext -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2
	 emcc main.o js.o -o v3020.js -mllvm -O0 -flto=thin -mtail-call -mmultivalue -mbulk-memory \
	 -mnontrapping-fptoint -msign-ext -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -emit-llvm \
	 -fwhole-program -polly -sALLOW_MEMORY_GROWTH=0 -sUSE_BOOST_HEADERS=1 -sUSE_WEBGPU=1 \
