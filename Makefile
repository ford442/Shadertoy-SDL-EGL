b3hd:
	 em++ src/b3main.cpp -c -O3 \
         -std=c++11 -stdlib=libc++ -mcpu=bleeding-edge -fwasm-exceptions -ftree-vectorize \
	 ...
	 em++ src/b3sdl.cpp -c \
	 -sUSE_SDL=2 -std=c++11 -stdlib=libc++ -fslp-vectorize -ftree-vectorize \
	 ...
	 -DNDEBUG -sWASM_BIGINT=1 -std=c++2b -stdlib=libc++ -mcpu=bleeding-edge -fwasm-exceptions \
