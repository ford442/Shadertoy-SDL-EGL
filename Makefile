b3hd:
	 ...
	 em++ src/b3ogl.cpp -c -nostdlib -fno-math-errno \
	 -std=c++2b -O0  \
	 ...
	 em++ src/b3emjs.cpp -c -O0 -nostdlib -fno-math-errno \
	 ...
	 em++ src/b3sdl.cpp -c -O0 -nostdlib -fno-math-errno \
	 ...
	 em++ src/b3main.cpp -c -O3 -nostdlib -fno-math-errno \
         -std=c++11 -mcpu=bleeding-edge -fwasm-exceptions -ftree-vectorize \
	 -mbulk-memory -msign-ext -ffast-math -ffp-contract=fast -freciprocal-math

	 em++ b3main.o b3sdl.o b3ogl.o  b3emjs.o -o g3020.js -O0 -DNDEBUG -fno-math-errno \
	 ...
	 -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sASSERTIONS=0 -USE_GLFW=0 \
         -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3","_b3_egl","_nano","_clr","_frm","_uni"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
