...
fire:
	 ...
	 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb -lembind -fwasm-exceptions \
	 -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 \
	 -sUSE_SDL=2 -sFULL_ES2=0 -sFULL_ES3=1 \
	 -std=gnu++2b -sPRECISE_F32=2 \
         -sEXPORTED_FUNCTIONS='["_main","_str","_pl","_b3","_nano"]' -sEXPORTED_RUNTIME_METHODS='["ccall"]' \
         --pre-js fluid.js --pre-js flui.js --pre-js setUp.js --pre-js startUp.js --post-js pagec.js --pre-js rSlider.js --pre-js slideOut.js --extern-pre-js gpujs.js
