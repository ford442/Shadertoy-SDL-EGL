...
tst2: main4.cpp  Makefile
	emcc main4.cpp -sFULL_ES2=0 -sFULL_ES3=1 --closure 0 -sGL_TESTING=0 -sUSE_SDL=2 -sEXPORT_NAME='createModule' -sMODULARIZE=1 \
...
-O3 -o egl12.js -sEXPORTED_FUNCTIONS='["_main","_pl","_str"]' -sEXPORTED_RUNTIME_METHODS=ccall \
