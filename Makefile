b3hd:
	 ...
	 -fuse-ld=mold -pthread -sPTHREAD_POOL_SIZE=2 -sPROXY_TO_PTHREAD -sENVIRONMENT=web,worker -sUSE_SDL=2 -sFORCE_FILESYSTEM=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=2048mb \
