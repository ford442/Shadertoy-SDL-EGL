LDFLAGS += -Wl,-O3,--lto-O3,--stack-first,-lc,-lc++,-lm,-lpthread,-lrt,-ldl,-S
...
GL_FLAGS += -sFULL_ES2=0 -sFULL_ES3=1 -sUSE_GLFW=0 -Wl,-lEGL,-lGL \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 -sGL_TRACK_ERRORS=0 

LINK_FLAGS += -fno-except $(LDFLAGS) -lpthread -sPTHREAD_POOL_SIZE=4 -sWASM_BIGINT=true --use-preload-plugins --closure 0 --closureFriendly \
