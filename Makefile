...
tst8b: egl4b.cpp  Makefile
	em++ egl4b.cpp -std=c++2b  -O3 -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1  -flto=thin  \
-sUSE_WEBGL2=1 -sENVIRONMENT=web -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sFORCE_FILESYSTEM=1 -sOFFSCREEN_FRAMEBUFFER=1 \
