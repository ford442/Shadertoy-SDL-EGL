...
SIMD_FLAGS += -msimd128 -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -mavx
...
-fPIC -fpie -finline-functions -funroll-loops -sDISABLE_EXCEPTION_CATCHING=1 \
...
GL_FLAGS += -sFULL_ES3=1 -sUSE_GLFW=0 -Wl,-lGL,-lGLU,-lEGL,-lGLESv2 -sGL_SUPPORT_EXPLICIT_SWAP_CONTROL=1 \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sGL_DEBUG=0 \
-sHTML5_SUPPORT_DEFERRING_USER_SENSITIVE_REQUESTS=0 -sGL_TRACK_ERRORS=0

LINK_FLAGS += $(LDFLAGS) -sABORT_ON_WASM_EXCEPTIONS=1 -sDEMANGLE_SUPPORT=0 -sWASMFS=0 -sASSERTIONS=0 --use-preload-plugins --closure 0 --closureFriendly \
	 ...
	 --memory-init-file 0 -rtlib=compiler-rt -sAUTO_ARCHIVE_INDEXES=0 -fno-except
...
b3_vanilla_webgpu:
	 ...
	 --pre-js src/vanilla/filesys.js --pre-js rSlider.js --pre-js slideOut.js \
...
b3_shader_webgpu:
	 ...
	 $(WEBGPU_FLAGS) -sFORCE_FILESYSTEM=1 -sINITIAL_MEMORY=512mb -sHTML5_SUPPORT_DEFERRING_USER_SENSITIVE_REQUESTS=0 \
