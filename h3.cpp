...
var alph=((((this.constants.fmax-this.constants.fmin)*0.75)+this.constants.fmin)+(((this.constants.amax-this.constants.amin)*0.75)+this.constants.amin)+(((1.0-this.constants.fmin)*0.75))+(((this.constants.fmax)*0.75))+((0.75-(0.75*(this.constants.favg-p[3])/(this.constants.fmax-this.constants.aavg))))+(this.constants.favg)+(0.75))/7;
