...
const glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g) {return (1.0-((min((ceil(e/g)),1.0)*(1.0-(((a-e)/2.0)+e)))+(1.0-((min((ceil(f/g)),1.0))*(1.0-(((c-f)/2)+f))))+(((a-e)/2)+e)+0.75)/4.0);}`;
