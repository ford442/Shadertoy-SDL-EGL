...
const glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g) {return (((((a - b) * 0.242201) + b) + (((c - d) * 0.7501) + d) + (((1.0 - (b / 2.0)) * 0.24999) + (b/2.0)) + (((1.0 - (c)) * 0.25111)) + ((0.2500303 - (0.2509 * (e - g) / (c-f)))) + ((f + 0.5) / 2.0)) / 6.0) ;}`;
