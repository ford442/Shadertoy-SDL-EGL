...
var alph=(((((this.constants.fmax-this.constants.fmin)*p[3])+this.constants.fmin)+(1.0-((p[3]-(this.constants.amax*0.75))*4))+(((this.constants.amax-this.constants.amin)*this.constants.aavg)+this.constants.amin)+((p[3]+this.constants.favg)/2))/4);
