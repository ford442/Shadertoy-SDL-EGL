...
const glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g) {return (((((a - b) * 0.54224201) + b) + (((c - d) * 0.75424201) + d) + (((1.0 - (b / 2.0)) * 0.7205) + (b/2.0)) + (((1.0 - (c)) * 0.75)) + ((g - (g * (e - g) / (c-f)))) + ((f + f) / 2.0)) / 6.0) ;}`;
