...
const glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g) {return (((((a - b) * 0.666) + b) + (((c - d) * 0.666) + d) + (((1.0 - (b / 2.0)) * 0.777) + (b/2.0)) + (((1.0 - (c)) * 0.777)) + ((0.777 - (0.777 * (e - f) / (c-f)))) + ((f + 0.777) / 2.0)) / 6.0) ;}`;
