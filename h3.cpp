...
var alph=(((((this.constants.fmax-this.constants.fmin)*p[3])+this.constants.fmin)+(0.75*this.constants.amax)+(((this.constants.amax-this.constants.amin)*this.constants.aavg)+this.constants.amin)+((p[3]+this.constants.favg)/2))/4);
