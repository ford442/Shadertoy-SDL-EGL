...
const glslAlphe=`float Alphe(float a,float b,float c,float d,float e,float f,float g) {return (((((a - b) * 0.242201) + b) + (((c - d) * 0.2501) + d) + (((1.0 - (b / 2.0)) * 0.74999) + (b/2.0)) + (((1.0 - (c)) * 0.75111)) + ((0.7500303 - (0.7509 * (e - g) / (c-f)))) + ((f + 0.74955) / 2.0)) / 6.0) ;}`;
