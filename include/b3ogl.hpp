...
"\n precision highp float;precision mediump sampler3D;precision mediump sampler2D;precision mediump samplerCube;precision mediump sampler2DArray;precision mediump sampler2DShadow;\n";
