...
GLfloat g1g=1.0,S;
GLsizei s4=4,i;
GLuint EBO,VBO,shd_prg,smp_chn[4],smp_chn_res,VCO,ECO,vtx,frag,uni_mse,shader,uni_srate,uni_alph,uni_res,uni_tme_dlt,uni_tme,uni_frm,uni_fps;
...
"\n uniform float iTime;uniform float iTimeDelta;in float iAlpha;uniform float iFrameRate;uniform vec4 iDate;uniform float iChannelTime[4];"
