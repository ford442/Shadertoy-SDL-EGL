double wi_js,hi_js;
double wi,hi;
double TtimeDelta,cMouseY,cMouseX,mouseY,mouseX,F=1.0f,Fm1=-1.0f,F0=0.0f;
...
int_fast32_t Size_js,Size,iFrame,iFps;
...
EmscriptenWebGLContextAttributes attr,attr_js;
EMSCRIPTEN_WEBGL_CONTEXT_HANDLE ctx,ctx_js;
