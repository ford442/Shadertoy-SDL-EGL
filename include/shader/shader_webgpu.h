...
glRenderbufferStorage(GL_RENDERBUFFER,GL_RGBA32UI,i_size.at(0,0)*2,i_size.at(0,0)*2);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glGenRenderbuffers(1,&TX.at(0,0,1));
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,1));
glRenderbufferStorage(GL_RENDERBUFFER,GL_DEPTH32F_STENCIL8,i_size.at(0,0)*2,i_size.at(0,0)*2);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glClearDepth(1.0);
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_RGB10_A2,i_size.at(0,0)*2,i_size.at(0,0)*2);
glBindRenderbuffer(GL_RENDERBUFFER,0);
          //  alpha renderbuffer
glGenRenderbuffers(1,&TX.at(0,1,1));
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,1,1));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_SRGB8_ALPHA8,i_size.at(0,0)*2,i_size.at(0,0)*2);
glBindRenderbuffer(GL_RENDERBUFFER,0);
   //  depth32 stencil8 renderbuffer
glGenRenderbuffers(1,&TX.at(0,0,1));
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,1));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH32F_STENCIL8,i_size.at(0,0)*2,i_size.at(0,0)*2);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glClearDepth(1.0);
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH_COMPONENT32F,i_size.at(0,0)*2,i_size.at(0,0)*2);
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
