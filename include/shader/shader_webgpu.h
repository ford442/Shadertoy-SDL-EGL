...
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,0));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_RGB32UI,wasm_i32x4_extract_lane(sse3.at(0,0),0),wasm_i32x4_extract_lane(sse3.at(0,0),0));
...
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,1));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,4,DEPTH32F_STENCIL8,wasm_i32x4_extract_lane(sse3.at(0,0),0),wasm_i32x4_extract_lane(sse3.at(0,0),0));
//glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
