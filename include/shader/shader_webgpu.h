...
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,0));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_RGB32UI,i_size.at(0,0),i_size.at(0,0));
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_STENCIL_INDEX8,i_size.at(0,0),i_size.at(0,0));
glClearDepthf(0.0f);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
