...
glRenderbufferStorage(GL_RENDERBUFFER,GL_DEPTH32F_STENCIL8,i_size.at(0,0),i_size.at(0,0));
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(2,0,0));
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_RGB10_A2,i_size.at(0,0)*1.25,i_size.at(0,0)*1.25);
glBindRenderbuffer(GL_RENDERBUFFER,0);
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_SRGB8_ALPHA8,i_size.at(0,0)*1.25,i_size.at(0,0)*1.25);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
...
glGenRenderbuffers(1,&TX.at(0,0,1));
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,1));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH32F_STENCIL8,i_size.at(0,0)*1.25,i_size.at(0,0)*1.25);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
glFramebufferRenderbuffer(GL_FRAMEBUFFER,GL_DEPTH_STENCIL_ATTACHMENT,GL_RENDERBUFFER,TX.at(0,0,1));
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH_COMPONENT32F,i_size.at(0,0)*1.25,i_size.at(0,0)*1.25);
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
...
emscripten_set_main_loop((void(*)())Run::procc.Rend,60,0);
return;
}
