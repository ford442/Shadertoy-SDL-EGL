...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_RGB10_A2,i_size.at(0,0)*1.33333,i_size.at(0,0)*1.33333);
glBindRenderbuffer(GL_RENDERBUFFER,0);
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_SRGB8_ALPHA8,i_size.at(0,0)*1.33333,i_size.at(0,0)*1.33333);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
...
glGenRenderbuffers(1,&TX.at(0,0,1));
glBindRenderbuffer(GL_RENDERBUFFER,TX.at(0,0,1));
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH32F_STENCIL8,i_size.at(0,0)*1.33333,i_size.at(0,0)*1.33333);
glBindRenderbuffer(GL_RENDERBUFFER,0);
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
glFramebufferRenderbuffer(GL_FRAMEBUFFER,GL_DEPTH_STENCIL_ATTACHMENT,GL_RENDERBUFFER,TX.at(0,0,1));
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,8,GL_DEPTH_COMPONENT32F,i_size.at(0,0)*1.33333,i_size.at(0,0)*1.33333);
glClearDepth(1.0);
glBindFramebuffer(GL_FRAMEBUFFER,TX.at(1,0,0));
