...
// EGL_GL_COLORSPACE_LINEAR_KHR,EGL_GL_COLORSPACE_SCRGB_LINEAR_EXT,
...
static gli_tensor i_size=gli_tensor{2,2};
...
const char * Fnm1=reinterpret_cast<const char *>("/shader/shader1.glsl");
const char * Fnm2=reinterpret_cast<const char *>("/shader/shader2.glsl");
const char * Fnm3=reinterpret_cast<const char *>("/shader/shader3.glsl");
const char * Fnm4=reinterpret_cast<const char *>("/shader/shader4.glsl");
const char * Fnm5=reinterpret_cast<const char *>("/shader/shader5.glsl");
const char * src[4];
...
uni_i.at(0,0)=0;
clk_l=true;
const char * frag_body1=procc.rd_fl(Fnm1);
const char * frag_body2=procc.rd_fl(Fnm2);
const char * frag_body3=procc.rd_fl(Fnm3);
const char * frag_body4=procc.rd_fl(Fnm4);
const char * frag_body5=procc.rd_fl(Fnm5);
...
emscripten_webgl_enable_extension(cntxi.at(0,0),"NV_shader_buffer_load");
emscripten_webgl_enable_extension(cntxi.at(0,0),"NV_shader_buffer_store");
emscripten_webgl_enable_extension(cntxi.at(0,0),"NV_gpu_program4");
emscripten_webgl_enable_extension(cntxi.at(0,0),"NV_gpu_program4_1");
...
src[2]=frag_body1;
src[3]=frg_ftr;
boost::uint_t<32>::exact frag1=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
src[2]=frag_body2;
boost::uint_t<32>::exact frag2=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
src[2]=frag_body3;
boost::uint_t<32>::exact frag3=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
src[2]=frag_body4;
boost::uint_t<32>::exact frag4=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
src[2]=frag_body5;
boost::uint_t<32>::exact frag5=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
  
boost::uint_t<32>::exact shd_prg=glCreateProgram();
PRGin(shd_prg);
::boost::tuples::tie(Sh,shd_prg);
// ::boost::tuples::tie(frag,vtx);
glAttachShader(S1.at(0,0,0),frag1);
glAttachShader(S1.at(0,0,0),frag2);
glAttachShader(S1.at(0,0,0),frag3);
glAttachShader(S1.at(0,0,0),frag4);
glAttachShader(S1.at(0,0,0),frag5);
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,4,GL_RGBA8,i_size.at(1,0),i_size.at(1,0));
...
glRenderbufferStorageMultisample(GL_RENDERBUFFER,4,GL_DEPTH_COMPONENT32F,i_size.at(0,0),i_size.at(0,0));
/// glClearDepth(1.0);
