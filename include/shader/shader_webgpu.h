...
EGL_GL_COLORSPACE_KHR,EGL_EXT_sRGB_COLORSPACE_LINEAR,
EGL_GL_COLORSPACE_LINEAR_KHR,EGL_EXT_sRGB_COLORSPACE_LINEAR,
EGL_NONE,EGL_NONE
};
...
EGL_RENDER_BUFFER,EGL_TRIPLE_BUFFER,
...
eglMakeCurrent(display,surface,surface,cntx.at(0,0));
  eglSetConfigClientVersion(display,3);
