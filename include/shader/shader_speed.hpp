...
uni_i.at(0,0)=0;
clk_l=true;
new const char * frag_body=rd_fl(Fnm);
...
src[0]=cm_hdr;
src[1]=vrt_bdy;
new unsigned int vtx=compile.cmpl_shd(GL_VERTEX_SHADER,2,src);
src[0]=cm_hdr;
src[1]=frg_hdr;
src[2]=frag_body;
src[3]=frg_ftr;
new unsigned int frag=compile.cmpl_shd(GL_FRAGMENT_SHADER,4,src);
