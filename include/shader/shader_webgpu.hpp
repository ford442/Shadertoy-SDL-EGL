...
// glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_WRAP_R,GL_REPEAT); // silver ball
...
glBufferData(GL_ARRAY_BUFFER,sizeof(vrt)*128,vrt,GL_DYNAMIC_DRAW);
 /* 
...
glBufferData(GL_ELEMENT_ARRAY_BUFFER,sizeof(indc)*128,indc,GL_DYNAMIC_DRAW);
...
glGetProgramBinary(S1.at(0,0,0),sizeof(GLbin)*128,binLength,binaryFormat,&GLbin);
bin.at(0,0)=GLbin;
// nanoPause();
...
glTexStorage2D(GL_TEXTURE_2D,0,GL_RGBA32F_EXT,int_size.at(0,0),int_size.at(0,0));
glTexSubImage2D(GL_TEXTURE_2D,0,0,0,int_size.at(0,0),int_size.at(0,0),GL_RGBA,GL_FLOAT,&ftexture[0]);
...
glTexStorage2D(GL_TEXTURE_2D,0,GL_RGBA32F_EXT,int_size.at(2,0),int_size.at(2,0));
glTexSubImage2D(GL_TEXTURE_2D,0,0,0,int_size.at(2,0),int_size.at(2,0),GL_RGBA,GL_FLOAT,&wtexture[0]);
glGenerateMipmap(GL_TEXTURE_2D);
glUniform1i(smp_chn[0],0);
...
// glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,int_size.at(2,0),int_size.at(2,0),0,GL_RGBA,GL_UNSIGNED_BYTE,ColorA);
glTexStorage2D(GL_TEXTURE_2D,0,GL_RGBA32F_EXT,int_size.at(2,0),int_size.at(2,0));
glTexSubImage2D(GL_TEXTURE_2D,0,0,0,int_size.at(2,0),int_size.at(2,0),GL_RGBA,GL_FLOAT,&wtexture[1]);
glGenerateMipmap(GL_TEXTURE_2D);
glUniform1i(smp_chn[1],1);
...
// glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,int_size.at(2,0),int_size.at(2,0),0,GL_RGBA,GL_UNSIGNED_BYTE,ColorA);
glTexStorage2D(GL_TEXTURE_2D,0,GL_RGBA32F_EXT,int_size.at(2,0),int_size.at(2,0));
glTexSubImage2D(GL_TEXTURE_2D,0,0,0,int_size.at(2,0),int_size.at(2,0),GL_RGBA,GL_FLOAT,&wtexture[2]);
glGenerateMipmap(GL_TEXTURE_2D);
glUniform1i(smp_chn[2],2);
glGenTextures(1,&wtexture[3]);
...
// glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,int_size.at(2,0),int_size.at(2,0),0,GL_RGBA,GL_UNSIGNED_BYTE,ColorA);
glTexStorage2D(GL_TEXTURE_2D,0,GL_RGBA32F_EXT,int_size.at(2,0),int_size.at(2,0));
glTexSubImage2D(GL_TEXTURE_2D,0,0,0,int_size.at(2,0),int_size.at(2,0),GL_RGBA,GL_FLOAT,&wtexture[3]);
glGenerateMipmap(GL_TEXTURE_2D);
glUniform1i(smp_chn[3],3);
// WGPU_Start();
// usleep(125);
