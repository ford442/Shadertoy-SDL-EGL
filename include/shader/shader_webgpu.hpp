...
glTexImage2D(GL_TEXTURE_2D,0,GL_SRGB_EXT,int_size.at(2,0),int_size.at(2,0),0,GL_SRGB_EXT,GL_UNSIGNED_BYTE,NULL);
...
glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MIN_FILTER,GL_NEAREST_MIPMAP_NEAREST);
glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MAG_FILTER,GL_NEAREST);
glTexImage2D(GL_TEXTURE_2D,0,GL_SRGBA_EXT,width1,height1,0,GL_SRGBA_EXT,GL_UNSIGNED_BYTE,ColorA);
glGenerateMipmap(GL_TEXTURE_2D);
glUniform1i(smp_chn[0],0);
