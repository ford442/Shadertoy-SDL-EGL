...
static inline boost::function<float()>gF __attribute__ ((const));
static inline boost::function<float()>gF5 __attribute__ ((const));
static inline boost::function<float()>gFm1 __attribute__ ((const));
static inline boost::function<float()>gFm5 __attribute__ ((const));
static inline boost::function<float()>gF0 __attribute__ ((const));
