...
static inline char32_t wgl_cmp_src[2000]=L"@group(0)@binding(0)var<storage,read>inputBuffer:array<u32,262144>;"
...
static inline char32_t cm_hdr_src[3300]=L"#version 300 es\n"
...
static inline char32_t vrt_bdy_src[420]=L"precision highp int;\n"
...
static inline char32_t frg_ftr_src[2420]=L"void main(){mainImage(fragColor,gl_FragCoord.xy);}\n\0";
/*
