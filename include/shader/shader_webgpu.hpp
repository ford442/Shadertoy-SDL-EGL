...
i_size.at(1,0)=wasm_i32x4_extract_lane(sse3.at(0,0),0)*0.85;
i_size.at(1,1)=wasm_i32x4_extract_lane(sse3.at(0,0),0)*0.85;
return EM_TRUE;
}
...
EMSCRIPTEN_WEBGL_CONTEXT_VERSION_MAJOR(4);
EMSCRIPTEN_WEBGL_CONTEXT_VERSION_MINOR(6);
