...
char reppc[26]="(void mainImage)+.+(\{)+.+";
std::string repp={(char *)reppc,regex_constants::ECMAScript};
std::string repp2={"(fragCoord)+.+",regex_constants::ECMAScript};
std::string repp3="{"(#version 330 es)+.+",regex_constants::ECMAScript};
std::regex rgx(repp);
