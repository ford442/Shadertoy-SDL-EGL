...
const char * filename=static_cast<const char *>("/shader/shader1.toy");
...
"precision lowp int;precision mediump float;precision highp sampler3D;precision highp sampler2D;"
