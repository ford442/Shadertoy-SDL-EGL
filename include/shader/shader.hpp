...
typedef struct{GLclampd XYZW[4];}Vertex;
...
const Vertex vertices[]={{gDm1,gDm1,gD,gD},{gD,gDm1,gD,gD},{gD,gD,gD,gD},{gDm1,gD,gD,gD},{gDm1,gDm1,gDm1,gD},{gD,gDm1,gDm1,gD},{gD,gD,gDm1,gD},{gDm1,gD,gD,gD}};
