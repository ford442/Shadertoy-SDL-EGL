...
wave.dev=Mix_OpenAudioDevice(request.freq,request.format,request.channels,request.samples,dev,SDL_AUDIO_ALLOW_FORMAT_CHANGE|SDL_AUDIO_ALLOW_SAMPLES_CHANGE);
