...
std::cout << fixed << setprecision(32) << "-----"<< ppi <<"-----" << std::endl;
std::cout << "-double------------" << std::endl;
std::cout << fixed << setprecision(32) << "-----"<< ppd <<"-----" << std::endl; 
...
std::cout << "----------float-----------" << std::endl;
std::cout << fixed << setprecision(32) << "-----"<< sx.at(1,1) <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
sy.at(1,1)=doubleAdd(3.14159265358979323846,3.14159265358979323846);
std::cout << "-----------double---------" << std::endl;
std::cout << fixed << setprecision(32) << "-----"<< sy.at(1,1) <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
...
std::cout << fixed << setprecision(32) << "--float---"<< ou2 <<"-----" << std::endl;
std::cout << fixed << setprecision(32) << "--double---"<< ou3 <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
std::cout << "--------------------------" << std::endl;
