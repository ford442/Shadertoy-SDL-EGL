...
std::cout << fixed << setprecision(15) << "-----"<< ppi <<"-----" << std::endl;
std::cout << "-double------------" << std::endl;
std::cout << fixed << setprecision(15) << "-----"<< ppd <<"-----" << std::endl; 
...
std::cout << "--------------------------" << std::endl;
std::cout << "--------------------------" << std::endl;
sx.at(1,1)=tensorAdd(3.14159265358979323846f,3.14159265358979323846f);
std::cout << "----------float-----------" << std::endl;
std::cout << fixed << setprecision(15) << "-----"<< sx.at(1,1) <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
sy.at(1,1)=doubleAdd(3.14159265358979323846,3.14159265358979323846);
std::cout << "-----------double---------" << std::endl;
std::cout << fixed << setprecision(15) << "-----"<< sy.at(1,1) <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
...
std::cout << fixed << setprecision(15) << "--float---"<< ou2 <<"-----" << std::endl;
std::cout << fixed << setprecision(15) << "--double---"<< ou3 <<"-----" << std::endl;
std::cout << "--------------------------" << std::endl;
std::cout << "--------------------------" << std::endl;
