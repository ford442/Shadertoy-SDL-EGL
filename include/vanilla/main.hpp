...
UserData userData;
wgpu::RequestDeviceCallback onDeviceRequestEnded=[](WGPURequestDeviceStatus status,wgpu::Device device,char const * message,void * pUserData){
...
userData.adapter=instance.RequestAdapter(&adapterOptions,onAdapterRequestEnded,&userData);
