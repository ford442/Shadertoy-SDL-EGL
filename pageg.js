...
mV.play();
setTimeout(function(){document.getElementById("btn2").click();},1000);
setTimeout(function(){document.getElementById("btn11").click();},1400);
setTimeout(function(){document.getElementById("btn77").click();},1800);
