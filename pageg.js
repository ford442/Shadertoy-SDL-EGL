...
mV.play();
setTimeout(function(){document.getElementById("btn2").click();},750);
setTimeout(function(){document.getElementById("btn11").click();},800);
...
setTimeout(function(){document.getElementById("tim").innerHTML=1600;},4200);
function loada(){
